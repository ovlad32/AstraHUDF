...
public class SubscriberExceptionContext {
  private final vendor.google.common.eventbus.EventBus eventBus;
  private final Object event;
  private final Object subscriber;
  private final Method subscriberMethod;

  /**
   * @param eventBus The {@link vendor.google.common.eventbus.EventBus} that handled the event and the subscriber. Useful for
  ...
  SubscriberExceptionContext(
          vendor.google.common.eventbus.EventBus eventBus, Object event, Object subscriber, Method subscriberMethod) {
  ...
  /**
   * @return The {@link vendor.google.common.eventbus.EventBus} that handled the event and the subscriber. Useful for broadcasting
