...
import vendor.google.common.collect.FluentIterable;
import vendor.google.common.collect.ForwardingSet;
import vendor.google.common.collect.ImmutableList;
import vendor.google.common.collect.ImmutableMap;
import vendor.google.common.collect.ImmutableSet;
import vendor.google.common.collect.Maps;
import vendor.google.common.collect.Ordering;
...
import vendor.google.common.primitives.Primitives;
...
public abstract class TypeToken<T> extends TypeCapture<T> implements Serializable {
  ...
  protected TypeToken(Class<?> declaringClass) {
    ...
    if (captured instanceof Class) {
      ...
      this.runtimeType = vendor.google.common.reflect.TypeResolver.covariantly(declaringClass).resolveType(captured);
    }
  }
  ...
  public final <X> TypeToken<T> where(TypeParameter<X> typeParam, TypeToken<X> typeArg) {
    vendor.google.common.reflect.TypeResolver resolver =
        new vendor.google.common.reflect.TypeResolver()
            .where(
                ImmutableMap.of(
                    new vendor.google.common.reflect.TypeResolver.TypeVariableKey(typeParam.typeVariable), typeArg.runtimeType));
  ...
  public final TypeToken<T> wrap() {
    if (isPrimitive()) {
      ...
      return of(vendor.google.common.primitives.Primitives.wrap(type));
    }
    return this;
  }

  private boolean isWrapper() {
    return vendor.google.common.primitives.Primitives.allWrapperTypes().contains(runtimeType);
  }
  ...
  protected Object writeReplace() {
    ...
    // except TypeVariable.
    return of(new vendor.google.common.reflect.TypeResolver().resolveType(runtimeType));
  }
  ...
  private vendor.google.common.reflect.TypeResolver getCovariantTypeResolver() {
    vendor.google.common.reflect.TypeResolver resolver = covariantTypeResolver;
    if (resolver == null) {
      resolver = (covariantTypeResolver = vendor.google.common.reflect.TypeResolver.covariantly(runtimeType));
    }
    return resolver;
  }

  private vendor.google.common.reflect.TypeResolver getInvariantTypeResolver() {
    vendor.google.common.reflect.TypeResolver resolver = invariantTypeResolver;
    if (resolver == null) {
      resolver = (invariantTypeResolver = vendor.google.common.reflect.TypeResolver.invariantly(runtimeType));
    }
    return resolver;
  }
  ...
  private Type resolveTypeArgsForSubclass(Class<?> subclass) {
    ...
    return new vendor.google.common.reflect.TypeResolver()
