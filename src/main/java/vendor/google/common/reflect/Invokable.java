...
package vendor.google.common.reflect;
 ...
 * #getParameters} etc.
 *
 * <p>In addition to convenience methods, {@link vendor.google.common.reflect.TypeToken#method} and {@link vendor.google.common.reflect.TypeToken#constructor}
 ...
 */
@Beta
public abstract class Invokable<T, R> extends vendor.google.common.reflect.Element implements GenericDeclaration {
  ...
  // All subclasses are owned by us and we'll make sure to get the R type right.
  @SuppressWarnings("unchecked")
  public final vendor.google.common.reflect.TypeToken<? extends R> getReturnType() {
    return (vendor.google.common.reflect.TypeToken<? extends R>) vendor.google.common.reflect.TypeToken.of(getGenericReturnType());
  }
   ...
   */
  public final ImmutableList<vendor.google.common.reflect.Parameter> getParameters() {
    Type[] parameterTypes = getGenericParameterTypes();
    Annotation[][] annotations = getParameterAnnotations();
    AnnotatedType[] annotatedTypes = getAnnotatedParameterTypes();
    ImmutableList.Builder<vendor.google.common.reflect.Parameter> builder = ImmutableList.builder();
    for (int i = 0; i < parameterTypes.length; i++) {
      builder.add(
          new Parameter(
              this, i, vendor.google.common.reflect.TypeToken.of(parameterTypes[i]), annotations[i], annotatedTypes[i]));
    }
    return builder.build();
  }

  /** Returns all declared exception types of this {@code Invokable}. */
  public final ImmutableList<vendor.google.common.reflect.TypeToken<? extends Throwable>> getExceptionTypes() {
    ImmutableList.Builder<vendor.google.common.reflect.TypeToken<? extends Throwable>> builder = ImmutableList.builder();
    for (Type type : getGenericExceptionTypes()) {
      // getGenericExceptionTypes() will never return a type that's not exception
      @SuppressWarnings("unchecked")
      vendor.google.common.reflect.TypeToken<? extends Throwable> exceptionType =
          (vendor.google.common.reflect.TypeToken<? extends Throwable>) vendor.google.common.reflect.TypeToken.of(type);
  ...
  public final <R1 extends R> Invokable<T, R1> returning(Class<R1> returnType) {
    return returning(vendor.google.common.reflect.TypeToken.of(returnType));
  }

  /** Explicitly specifies the return type of this {@code Invokable}. */
  public final <R1 extends R> Invokable<T, R1> returning(vendor.google.common.reflect.TypeToken<R1> returnType) {
  ...
  @Override
  public vendor.google.common.reflect.TypeToken<T> getOwnerType() {
    return (vendor.google.common.reflect.TypeToken<T>) TypeToken.of(getDeclaringClass());
  }
  ...
  static class ConstructorInvokable<T> extends Invokable<T, T> {
    ...
    Type getGenericReturnType() {
      ...
      if (typeParams.length > 0) {
        return vendor.google.common.reflect.Types.newParameterizedType(declaringClass, typeParams);
      } else {
