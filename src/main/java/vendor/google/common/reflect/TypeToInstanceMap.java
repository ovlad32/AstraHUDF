...
/**
 * A map, each entry of which maps a {@link vendor.google.common.reflect.TypeToken} to an instance of that type. In addition to
 ...
 * way to check an object at runtime to be an instance of a {@link vendor.google.common.reflect.TypeToken}. Instead, caller
 ...
 */
@Beta
public interface TypeToInstanceMap<B> extends Map<vendor.google.common.reflect.TypeToken<? extends B>, B> {
   ...
   */
  <T extends B> @Nullable T getInstance(vendor.google.common.reflect.TypeToken<T> type);
