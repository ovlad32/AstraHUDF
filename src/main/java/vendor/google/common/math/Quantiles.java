...
public final class Quantiles {
  ...
  public static final class ScaleAndIndex {
    ...
    public double compute(Collection<? extends Number> dataset) {
      return computeInPlace(vendor.google.common.primitives.Doubles.toArray(dataset));
    }
    ...
    public double computeInPlace(double... dataset) {
      ...
      int quotient = (int) vendor.google.common.math.LongMath.divide(numerator, scale, RoundingMode.DOWN);
