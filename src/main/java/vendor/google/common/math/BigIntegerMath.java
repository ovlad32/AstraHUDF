...
package vendor.google.common.math;
...
import static vendor.google.common.math.MathPreconditions.checkNonNegative;
import static vendor.google.common.math.MathPreconditions.checkPositive;
 ...
 * {@link vendor.google.common.math.LongMath} respectively.
 *
...
public final class BigIntegerMath {
  ...
  public static int log10(BigInteger x, RoundingMode mode) {
    ...
    if (fitsInLong(x)) {
      return vendor.google.common.math.LongMath.log10(x.longValue(), mode);
    }
  ...
  public static BigInteger sqrt(BigInteger x, RoundingMode mode) {
    ...
    if (fitsInLong(x)) {
      return BigInteger.valueOf(vendor.google.common.math.LongMath.sqrt(x.longValue(), mode));
    }
  ...
  public static BigInteger factorial(int n) {
    ...
    if (n < vendor.google.common.math.LongMath.factorials.length) {
      return BigInteger.valueOf(vendor.google.common.math.LongMath.factorials[n]);
    }
    ...
    int startingNumber = vendor.google.common.math.LongMath.factorials.length;
    long product = vendor.google.common.math.LongMath.factorials[startingNumber - 1];
    // Strip off 2s from this value.
    int shift = Long.numberOfTrailingZeros(product);
    product >>= shift;

    // Use floor(log2(num)) + 1 to prevent overflow of multiplication.
    int productBits = vendor.google.common.math.LongMath.log2(product, FLOOR) + 1;
    int bits = vendor.google.common.math.LongMath.log2(startingNumber, FLOOR) + 1;
    ...
    for (long num = startingNumber; num <= n; num++) {
      ...
      productBits = vendor.google.common.math.LongMath.log2(product, FLOOR) + 1;
    }
    // Check for leftovers.
    if (product > 1) {
      bignums.add(BigInteger.valueOf(product));
  ...
  public static BigInteger binomial(int n, int k) {
    ...
    if (k < vendor.google.common.math.LongMath.biggestBinomials.length && n <= vendor.google.common.math.LongMath.biggestBinomials[k]) {
      return BigInteger.valueOf(vendor.google.common.math.LongMath.binomial(n, k));
    }
