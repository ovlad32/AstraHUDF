 ...
 *       hunt through classes like {@link Arrays} and {@link vendor.google.common.primitives.Ints} for them.
...
public final class ImmutableIntArray implements Serializable {
  ...
  public static ImmutableIntArray copyOf(Collection<Integer> values) {
    return values.isEmpty() ? EMPTY : new ImmutableIntArray(vendor.google.common.primitives.Ints.toArray(values));
  }
  ...
  public static final class Builder {
    ...
    public Builder addAll(IntStream stream) {
      ...
      if (size > 0) { // known *and* nonempty
        ensureRoomFor(vendor.google.common.primitives.Ints.saturatedCast(size));
      }
