 ...
 *       hunt through classes like {@link Arrays} and {@link vendor.google.common.primitives.Doubles} for them.
...
public final class ImmutableDoubleArray implements Serializable {
  ...
  public static ImmutableDoubleArray copyOf(Collection<Double> values) {
    return values.isEmpty() ? EMPTY : new ImmutableDoubleArray(vendor.google.common.primitives.Doubles.toArray(values));
  }
