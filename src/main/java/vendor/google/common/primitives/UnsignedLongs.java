 ...
 * 2^64 + x}). The methods for which signedness is not an issue are in {@link vendor.google.common.primitives.Longs}, as well as
...
public final class UnsignedLongs {
  ...
  public static long decode(String stringValue) {
    vendor.google.common.primitives.ParseRequest request = vendor.google.common.primitives.ParseRequest.fromString(stringValue);
