...
final class Platform {
  ...
  static <T extends Enum<T>> vendor.google.common.base.Optional<T> getEnumIfPresent(Class<T> enumClass, String value) {
    WeakReference<? extends Enum<?>> ref = Enums.getEnumConstants(enumClass).get(value);
    return ref == null ? vendor.google.common.base.Optional.<T>absent() : Optional.of(enumClass.cast(ref.get()));
  }
