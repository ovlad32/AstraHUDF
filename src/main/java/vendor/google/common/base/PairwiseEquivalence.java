...
final class PairwiseEquivalence<T> extends vendor.google.common.base.Equivalence<Iterable<T>> implements Serializable {

  final vendor.google.common.base.Equivalence<? super T> elementEquivalence;
