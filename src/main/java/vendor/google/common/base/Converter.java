...
import vendor.google.common.primitives.Doubles;
 ...
 */
@GwtCompatible
public abstract class Converter<A, B> implements vendor.google.common.base.Function<A, B> {
   ...
   *     vendor.google.common.base.Function}.
   */
  @ForOverride
  ...
  public static <A, B> Converter<A, B> from(
      vendor.google.common.base.Function<? super A, ? extends B> forwardFunction,
      vendor.google.common.base.Function<? super B, ? extends A> backwardFunction) {
    return new FunctionBasedConverter<>(forwardFunction, backwardFunction);
  }

  private static final class FunctionBasedConverter<A, B> extends Converter<A, B>
      implements Serializable {
    private final vendor.google.common.base.Function<? super A, ? extends B> forwardFunction;
    private final vendor.google.common.base.Function<? super B, ? extends A> backwardFunction;
