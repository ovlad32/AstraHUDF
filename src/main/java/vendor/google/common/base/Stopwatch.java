 ...
 *
 * <p>When testing code that uses this class, use {@link #createUnstarted(vendor.google.common.base.Ticker)} or {@link
 * #createStarted(vendor.google.common.base.Ticker)} to supply a fake or mock ticker. This allows you to simulate any valid
...
public final class Stopwatch {
  private final vendor.google.common.base.Ticker ticker;
   ...
   * @since 15.0
   */
  public static Stopwatch createUnstarted(vendor.google.common.base.Ticker ticker) {
   ...
   * @since 15.0
   */
  public static Stopwatch createStarted(vendor.google.common.base.Ticker ticker) {
    return new Stopwatch(ticker).start();
  }

  Stopwatch() {
    this.ticker = vendor.google.common.base.Ticker.systemTicker();
  }
  ...
  public String toString() {
    ...
    return vendor.google.common.base.Platform.formatCompact4Digits(value) + " " + abbreviate(unit);
  }
