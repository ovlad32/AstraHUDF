...
public abstract class Equivalence<T> implements BiPredicate<T, T> {
   ...
   * relation. That is, invoking {@link vendor.google.common.base.Function#apply} multiple times for a given value must return
  ...
  public final <F> Equivalence<F> onResultOf(Function<F, ? extends T> function) {
    return new vendor.google.common.base.FunctionalEquivalence<>(function, this);
  }
  ...
  private static final class EquivalentToPredicate<T> implements Predicate<T>, Serializable {
    ...
    public boolean equals(@Nullable Object obj) {
      ...
      if (obj instanceof EquivalentToPredicate) {
        ...
        return equivalence.equals(that.equivalence) && vendor.google.common.base.Objects.equal(target, that.target);
      }
      return false;
    }
