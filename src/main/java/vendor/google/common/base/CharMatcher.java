...
public abstract class CharMatcher implements Predicate<Character> {
  ...
  public CharMatcher precomputed() {
    return vendor.google.common.base.Platform.precomputeCharMatcher(this);
  }
   ...
   * on {@link vendor.google.common.base.Platform} so that we can have different behavior in GWT.
   *
   ...
   */
  @vendor.google.common.annotations.GwtIncompatible // SmallCharMatcher
    ...
    switch (totalCharacters) {
      ...
      default:
        return isSmall(totalCharacters, table.length())
            ? vendor.google.common.base.SmallCharMatcher.from(table, description)
  ...
  private static boolean isSmall(int totalCharacters, int tableLength) {
    return totalCharacters <= vendor.google.common.base.SmallCharMatcher.MAX_SIZE
  ...
  @vendor.google.common.annotations.GwtIncompatible // used only from other GwtIncompatible code
