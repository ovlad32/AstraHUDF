...
public final class Predicates {
   ...
   */
  @vendor.google.common.annotations.GwtIncompatible // Class.isAssignableFrom
  @Beta
  ...
  public static <A, B> Predicate<A> compose(
      Predicate<B> predicate, vendor.google.common.base.Function<A, ? extends B> function) {
   ...
   * @since 3.0
   */
  @vendor.google.common.annotations.GwtIncompatible // Only used by other GWT-incompatible code.
   ...
   * @since 3.0
   */
  @vendor.google.common.annotations.GwtIncompatible(value = "java.util.regex.Pattern")
  ...
  /** @see Predicates#compose(Predicate, vendor.google.common.base.Function) */
  private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
    final Predicate<B> p;
    final vendor.google.common.base.Function<A, ? extends B> f;
  ...
  private static class ContainsPatternFromStringPredicate extends ContainsPatternPredicate {
    ...
    ContainsPatternFromStringPredicate(String string) {
      super(vendor.google.common.base.Platform.compilePattern(string));
    }
