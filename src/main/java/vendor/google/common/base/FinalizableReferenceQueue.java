 ...
 * {@link vendor.google.common.base.FinalizableReference#finalizeReferent()} on them.
 *
...
public class FinalizableReferenceQueue implements Closeable {
  ...
  private static final String FINALIZER_CLASS_NAME = "Finalizer";
  ...
  public FinalizableReferenceQueue() {
    ...
    try {
      startFinalizer.invoke(null, vendor.google.common.base.FinalizableReference.class, queue, frqRef);
      threadStarted = true;
   ...
   * vendor.google.common.base.FinalizableReference#finalizeReferent()} on them until the queue is empty. This method is a
