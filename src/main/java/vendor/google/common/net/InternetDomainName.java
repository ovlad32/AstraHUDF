...
import vendor.google.thirdparty.publicsuffix.PublicSuffixPatterns;
import vendor.google.thirdparty.publicsuffix.PublicSuffixType;
...
public final class InternetDomainName {
  ...
  private static final vendor.google.common.base.CharMatcher DOTS_MATCHER = vendor.google.common.base.CharMatcher.anyOf(".\u3002\uFF0E\uFF61");
  private static final vendor.google.common.base.Splitter DOT_SPLITTER = Splitter.on('.');
  private static final vendor.google.common.base.Joiner DOT_JOINER = Joiner.on('.');
  ...
  private final vendor.google.common.collect.ImmutableList<String> parts;
  ...
  InternetDomainName(String name) {
    ...
    this.parts = vendor.google.common.collect.ImmutableList.copyOf(DOT_SPLITTER.split(name));
  ...
  private static final vendor.google.common.base.CharMatcher DASH_MATCHER = vendor.google.common.base.CharMatcher.anyOf("-_");

  private static final vendor.google.common.base.CharMatcher PART_CHAR_MATCHER =
      vendor.google.common.base.CharMatcher.javaLetterOrDigit().or(DASH_MATCHER);
  ...
  private static boolean validatePart(String part, boolean isFinalPart) {
    ...
    String asciiChars = vendor.google.common.base.CharMatcher.ascii().retainFrom(part);
