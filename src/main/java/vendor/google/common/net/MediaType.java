...
package vendor.google.common.net;
...
import vendor.google.common.base.*;
...
public final class MediaType {
  ...
  private static final vendor.google.common.collect.ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS =
      vendor.google.common.collect.ImmutableListMultimap.of(CHARSET_ATTRIBUTE, vendor.google.common.base.Ascii.toLowerCase(Charsets.UTF_8.name()));

  /** Matcher for type, subtype and attributes. */
  private static final vendor.google.common.base.CharMatcher TOKEN_MATCHER =
      vendor.google.common.base.CharMatcher.ascii()
          .and(vendor.google.common.base.CharMatcher.javaIsoControl().negate())
          .and(vendor.google.common.base.CharMatcher.isNot(' '))
          .and(vendor.google.common.base.CharMatcher.noneOf("()<>@,;:\\\"/[]?="));

  private static final vendor.google.common.base.CharMatcher QUOTED_TEXT_MATCHER = vendor.google.common.base.CharMatcher.ascii().and(vendor.google.common.base.CharMatcher.noneOf("\"\\\r"));
   ...
   */
  private static final vendor.google.common.base.CharMatcher LINEAR_WHITE_SPACE = vendor.google.common.base.CharMatcher.anyOf(" \t\r\n");
  ...
  private static final Map<MediaType, MediaType> KNOWN_TYPES = vendor.google.common.collect.Maps.newHashMap();

  private static MediaType createConstant(String type, String subtype) {
    MediaType mediaType =
        addKnownType(new MediaType(type, subtype, vendor.google.common.collect.ImmutableListMultimap.<String, String>of()));
  ...
  private final vendor.google.common.collect.ImmutableListMultimap<String, String> parameters;
  ...
  private MediaType(String type, String subtype, vendor.google.common.collect.ImmutableListMultimap<String, String> parameters) {
    this.type = type;
  ...
  public vendor.google.common.collect.ImmutableListMultimap<String, String> parameters() {
    return parameters;
  }

  private Map<String, vendor.google.common.collect.ImmutableMultiset<String>> parametersAsMap() {
    return Maps.transformValues(
        parameters.asMap(),
        new vendor.google.common.base.Function<Collection<String>, vendor.google.common.collect.ImmutableMultiset<String>>() {
          @Override
          public vendor.google.common.collect.ImmutableMultiset<String> apply(Collection<String> input) {
   ...
   */
  public MediaType withParameters(vendor.google.common.collect.Multimap<String, String> parameters) {
  ...
  public MediaType withParameters(String attribute, Iterable<String> values) {
    ...
    vendor.google.common.collect.ImmutableListMultimap.Builder<String, String> builder = vendor.google.common.collect.ImmutableListMultimap.builder();
  ...
  public static MediaType create(String type, String subtype) {
    MediaType mediaType = create(type, subtype, vendor.google.common.collect.ImmutableListMultimap.<String, String>of());
    mediaType.parsedCharset = Optional.absent();
    return mediaType;
  }

  private static MediaType create(
      String type, String subtype, vendor.google.common.collect.Multimap<String, String> parameters) {
  ...
  private static String normalizeToken(String token) {
    ...
    return vendor.google.common.base.Ascii.toLowerCase(token);
  }
  ...
  public static MediaType parse(String input) {
    ...
    try {
      ...
      vendor.google.common.collect.ImmutableListMultimap.Builder<String, String> parameters = ImmutableListMultimap.builder();
      while (tokenizer.hasMore()) {
        ...
        if ('"' == tokenizer.previewChar()) {
          ...
          while ('"' != tokenizer.previewChar()) {
            if ('\\' == tokenizer.previewChar()) {
              tokenizer.consumeCharacter('\\');
              valueBuilder.append(tokenizer.consumeCharacter(vendor.google.common.base.CharMatcher.ascii()));
            } else {
  ...
  private static final class Tokenizer {
    ...
    String consumeTokenIfPresent(vendor.google.common.base.CharMatcher matcher) {
    ...
    String consumeToken(vendor.google.common.base.CharMatcher matcher) {
      int startPosition = position;
    ...
    char consumeCharacter(vendor.google.common.base.CharMatcher matcher) {
      Preconditions.checkState(hasMore());
      char c = previewChar();
  ...
  private static final vendor.google.common.base.Joiner.MapJoiner PARAMETER_JOINER = vendor.google.common.base.Joiner.on("; ").withKeyValueSeparator("=");
