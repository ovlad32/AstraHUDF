...
public final class RemovalListeners {
   ...
   */
  public static <K, V> vendor.google.common.cache.RemovalListener<K, V> asynchronous(
          final vendor.google.common.cache.RemovalListener<K, V> listener, final Executor executor) {
