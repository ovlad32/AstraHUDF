...
/**
 * Statistics about the performance of a {@link vendor.google.common.cache.Cache}. Instances of this class are immutable.
 *
 ...
 *   <li>No stats are modified by operations invoked on the {@linkplain vendor.google.common.cache.Cache#asMap asMap} view of
 *       the cache.
 * </ul>
 *
 * <p>A lookup is specifically defined as an invocation of one of the methods {@link
 * LoadingCache#get(Object)}, {@link LoadingCache#getUnchecked(Object)}, {@link vendor.google.common.cache.Cache#get(Object,
...
public final class CacheStats {
  ...
  /**
   * Returns the number of times {@link vendor.google.common.cache.Cache} lookup methods have returned either a cached or
  ...
  /** Returns the number of times {@link vendor.google.common.cache.Cache} lookup methods have returned a cached value. */
  ...
  /**
   * Returns the number of times {@link vendor.google.common.cache.Cache} lookup methods have returned an uncached (newly
   * loaded) value, or null. Multiple concurrent calls to {@link vendor.google.common.cache.Cache} lookup methods on an absent
  ...
  /**
   * Returns the total number of times that {@link vendor.google.common.cache.Cache} lookup methods attempted to load new
  ...
  /**
   * Returns the number of times {@link vendor.google.common.cache.Cache} lookup methods have successfully loaded a new value.
  ...
  /**
   * Returns the number of times {@link vendor.google.common.cache.Cache} lookup methods threw an exception while loading a new
