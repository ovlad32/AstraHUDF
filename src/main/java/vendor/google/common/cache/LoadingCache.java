...
public interface LoadingCache<K, V> extends Cache<K, V>, Function<K, V> {
   ...
   *
   * <p>Caches loaded by a {@link vendor.google.common.cache.CacheLoader} will call {@link vendor.google.common.cache.CacheLoader#load} to load new values
   ...
   *
   * <p>Caches loaded by a {@link vendor.google.common.cache.CacheLoader} will issue a single request to {@link
   * vendor.google.common.cache.CacheLoader#loadAll} for all keys which are not already present in the cache. All entries
   * returned by {@link vendor.google.common.cache.CacheLoader#loadAll} will be stored in the cache, over-writing any
   * previously cached values. This method will throw an exception if {@link vendor.google.common.cache.CacheLoader#loadAll}
   ...
   *
   * <p>Caches loaded by a {@link vendor.google.common.cache.CacheLoader} will call {@link vendor.google.common.cache.CacheLoader#reload} if the cache
   * currently contains a value for {@code key}, and {@link vendor.google.common.cache.CacheLoader#load} otherwise. Loading is
