...
public abstract class ForwardingLoadingCache<K, V> extends ForwardingCache<K, V>
    implements vendor.google.common.cache.LoadingCache<K, V> {

  /** Constructor for use by subclasses. */
  protected ForwardingLoadingCache() {}

  @Override
  protected abstract vendor.google.common.cache.LoadingCache<K, V> delegate();
   ...
   * constructed {@link vendor.google.common.cache.LoadingCache} as the delegate.
   *
   * @since 10.0
   */
  public abstract static class SimpleForwardingLoadingCache<K, V>
      extends ForwardingLoadingCache<K, V> {
    private final vendor.google.common.cache.LoadingCache<K, V> delegate;

    protected SimpleForwardingLoadingCache(vendor.google.common.cache.LoadingCache<K, V> delegate) {
