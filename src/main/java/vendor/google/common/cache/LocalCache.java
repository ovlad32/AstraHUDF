...
package vendor.google.common.cache;
...
import static vendor.google.common.util.concurrent.Futures.transform;
import static vendor.google.common.util.concurrent.MoreExecutors.directExecutor;
...
import vendor.google.common.base.Ticker;
import vendor.google.common.util.concurrent.ExecutionError;
import vendor.google.common.util.concurrent.Futures;
import vendor.google.common.util.concurrent.ListenableFuture;
import vendor.google.common.util.concurrent.SettableFuture;
import vendor.google.common.util.concurrent.UncheckedExecutionException;
import vendor.google.common.util.concurrent.Uninterruptibles;
...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
   ...
   */
  @vendor.google.common.annotations.VisibleForTesting
  ...
  static class LoadingValueReference<K, V> implements ValueReference<K, V> {
    ...
    public ListenableFuture<V> loadFuture(K key, CacheLoader<? super K, V> loader) {
      try {
        ...
        return transform(
            newValue,
            new vendor.google.common.base.Function<V, V>() {
              @Override
  ...
  static final class WriteQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
    ...
    public Iterator<ReferenceEntry<K, V>> iterator() {
      return new vendor.google.common.collect.AbstractSequentialIterator<ReferenceEntry<K, V>>(peek()) {
        @Override
  ...
  vendor.google.common.collect.ImmutableMap<K, V> getAllPresent(Iterable<?> keys) {
    int hits = 0;
    int misses = 0;

    Map<K, V> result = vendor.google.common.collect.Maps.newLinkedHashMap();
    for (Object key : keys) {
      V value = get(key);
      if (value == null) {
        misses++;
    ...
    return vendor.google.common.collect.ImmutableMap.copyOf(result);
  }

  vendor.google.common.collect.ImmutableMap<K, V> getAll(Iterable<? extends K> keys) throws ExecutionException {
    int hits = 0;
    int misses = 0;
  ...
  static final class LoadingSerializationProxy<K, V> extends ManualSerializationProxy<K, V>
    ...
    @Override
    public vendor.google.common.collect.ImmutableMap<K, V> getAll(Iterable<? extends K> keys) throws ExecutionException {
  ...
  static class LocalManualCache<K, V> implements Cache<K, V>, Serializable {
    ...
    @Override
    public vendor.google.common.collect.ImmutableMap<K, V> getAllPresent(Iterable<?> keys) {
