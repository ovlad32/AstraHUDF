 ...
 */
@GwtCompatible
public abstract class AbstractCache<K, V> implements vendor.google.common.cache.Cache<K, V> {
  ...
  @Override
  public vendor.google.common.cache.CacheStats stats() {
    throw new UnsupportedOperationException();
  }
  ...
  /**
   * Accumulates statistics during the operation of a {@link vendor.google.common.cache.Cache} for presentation by {@link
   * vendor.google.common.cache.Cache#stats}. This is solely intended for consumption by {@code Cache} implementors.
   *
   * @since 10.0
   */
  public interface StatsCounter {
     ...
     * blocking on the load. Multiple concurrent calls to {@link vendor.google.common.cache.Cache} lookup methods with the same
     ...
     * vendor.google.common.cache.Cache#invalidate invalidations}.
     */
    void recordEviction();
     ...
     */
    vendor.google.common.cache.CacheStats snapshot();
  }
  ...
  public static final class SimpleStatsCounter implements StatsCounter {
    private final vendor.google.common.cache.LongAddable hitCount = LongAddables.create();
    private final vendor.google.common.cache.LongAddable missCount = LongAddables.create();
    private final vendor.google.common.cache.LongAddable loadSuccessCount = LongAddables.create();
    private final vendor.google.common.cache.LongAddable loadExceptionCount = LongAddables.create();
    private final vendor.google.common.cache.LongAddable totalLoadTime = LongAddables.create();
    private final vendor.google.common.cache.LongAddable evictionCount = LongAddables.create();
    ...
    @Override
    public vendor.google.common.cache.CacheStats snapshot() {
      return new vendor.google.common.cache.CacheStats(
          hitCount.sum(),
          missCount.sum(),
