...
final class UndirectedMultiNetworkConnections<N, E>
  ...
  @LazyInit private transient Reference<vendor.google.common.collect.Multiset<N>> adjacentNodesReference;
  ...
  private vendor.google.common.collect.Multiset<N> adjacentNodesMultiset() {
    vendor.google.common.collect.Multiset<N> adjacentNodes = getReference(adjacentNodesReference);
