...
import vendor.google.common.collect.UnmodifiableIterator;
...
public abstract class Traverser<N> {
  ...
  private static final class GraphTraverser<N> extends Traverser<N> {
    ...
    public Iterable<N> breadthFirst(final N startNode) {
      ...
      return breadthFirst(vendor.google.common.collect.ImmutableSet.of(startNode));
    }

    @Override
    public Iterable<N> breadthFirst(final Iterable<? extends N> startNodes) {
      checkNotNull(startNodes);
      if (vendor.google.common.collect.Iterables.isEmpty(startNodes)) {
        return vendor.google.common.collect.ImmutableSet.of();
      }
    ...
    public Iterable<N> depthFirstPreOrder(final N startNode) {
      checkNotNull(startNode);
      return depthFirstPreOrder(vendor.google.common.collect.ImmutableSet.of(startNode));
    }
    ...
    public Iterable<N> depthFirstPostOrder(final N startNode) {
      checkNotNull(startNode);
      return depthFirstPostOrder(vendor.google.common.collect.ImmutableSet.of(startNode));
    }
    ...
    private final class BreadthFirstIterator extends vendor.google.common.collect.UnmodifiableIterator<N> {
    ...
    private final class DepthFirstIterator extends vendor.google.common.collect.AbstractIterator<N> {
