...
abstract class AbstractBaseGraph<N> implements BaseGraph<N> {
  ...
  public Set<EndpointPair<N>> edges() {
    return new AbstractSet<EndpointPair<N>>() {
      @Override
      public vendor.google.common.collect.UnmodifiableIterator<EndpointPair<N>> iterator() {
  ...
  private abstract static class IncidentEdgeSet<N> extends AbstractSet<EndpointPair<N>> {
    ...
    private static final class Directed<N> extends IncidentEdgeSet<N> {
      ...
      @Override
      public vendor.google.common.collect.UnmodifiableIterator<EndpointPair<N>> iterator() {
        return vendor.google.common.collect.Iterators.unmodifiableIterator(
            vendor.google.common.collect.Iterators.concat(
                vendor.google.common.collect.Iterators.transform(
