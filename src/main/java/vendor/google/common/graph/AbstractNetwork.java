...
import static vendor.google.common.graph.GraphConstants.ENDPOINTS_MISMATCH;
import static vendor.google.common.graph.GraphConstants.MULTIPLE_EDGES_CONNECTING;
...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
  ...
  public Set<E> adjacentEdges(E edge) {
    ...
    Set<E> endpointPairIncidentEdges =
        vendor.google.common.collect.Sets.union(incidentEdges(endpointPair.nodeU()), incidentEdges(endpointPair.nodeV()));
    return vendor.google.common.collect.Sets.difference(endpointPairIncidentEdges, ImmutableSet.of(edge));
  }
  ...
  public Set<E> edgesConnecting(N nodeU, N nodeV) {
    ...
    return outEdgesU.size() <= inEdgesV.size()
        ? unmodifiableSet(vendor.google.common.collect.Sets.filter(outEdgesU, connectedPredicate(nodeU, nodeV)))
