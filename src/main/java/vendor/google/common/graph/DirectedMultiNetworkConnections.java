...
import static vendor.google.common.graph.GraphConstants.INNER_CAPACITY;
import static vendor.google.common.graph.GraphConstants.INNER_LOAD_FACTOR;
...
import vendor.google.common.collect.HashMultiset;
import vendor.google.common.collect.ImmutableMap;
import vendor.google.common.collect.Multiset;
...
final class DirectedMultiNetworkConnections<N, E> extends AbstractDirectedNetworkConnections<N, E> {
  ...
  static <N, E> DirectedMultiNetworkConnections<N, E> ofImmutable(
      Map<E, N> inEdges, Map<E, N> outEdges, int selfLoopCount) {
    return new DirectedMultiNetworkConnections<>(
        vendor.google.common.collect.ImmutableMap.copyOf(inEdges), ImmutableMap.copyOf(outEdges), selfLoopCount);
  }

  @LazyInit private transient Reference<vendor.google.common.collect.Multiset<N>> predecessorsReference;
  ...
  private vendor.google.common.collect.Multiset<N> predecessorsMultiset() {
    vendor.google.common.collect.Multiset<N> predecessors = getReference(predecessorsReference);
    if (predecessors == null) {
      predecessors = vendor.google.common.collect.HashMultiset.create(inEdgeMap.values());
      predecessorsReference = new SoftReference<>(predecessors);
    }
    return predecessors;
  }

  @LazyInit private transient Reference<vendor.google.common.collect.Multiset<N>> successorsReference;
  ...
  private vendor.google.common.collect.Multiset<N> successorsMultiset() {
    vendor.google.common.collect.Multiset<N> successors = getReference(successorsReference);
    if (successors == null) {
