...
public final class ImmutableNetwork<N, E> extends ConfigurableNetwork<N, E> {
  ...
  private static <N, E> Map<N, NetworkConnections<N, E>> getNodeConnections(Network<N, E> network) {
    ...
    vendor.google.common.collect.ImmutableMap.Builder<N, NetworkConnections<N, E>> nodeConnections = vendor.google.common.collect.ImmutableMap.builder();
  ...
  private static <N, E> Map<E, N> getEdgeToReferenceNode(Network<N, E> network) {
    ...
    vendor.google.common.collect.ImmutableMap.Builder<E, N> edgeToReferenceNode = ImmutableMap.builder();
  ...
  private static <N, E> NetworkConnections<N, E> connectionsOf(Network<N, E> network, N node) {
    if (network.isDirected()) {
      Map<E, N> inEdgeMap = vendor.google.common.collect.Maps.asMap(network.inEdges(node), sourceNodeFn(network));
      Map<E, N> outEdgeMap = vendor.google.common.collect.Maps.asMap(network.outEdges(node), targetNodeFn(network));
