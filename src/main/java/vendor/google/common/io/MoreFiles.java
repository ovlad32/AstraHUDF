...
public final class MoreFiles {
   ...
   */
  public static vendor.google.common.collect.ImmutableList<Path> listFiles(Path dir) throws IOException {
    try (DirectoryStream<Path> stream = Files.newDirectoryStream(dir)) {
      return vendor.google.common.collect.ImmutableList.copyOf(stream);
   ...
   */
  public static vendor.google.common.base.Predicate<Path> isDirectory(LinkOption... options) {
    final LinkOption[] optionsCopy = options.clone();
    return new vendor.google.common.base.Predicate<Path>() {
      @Override
   ...
   * LinkOption...)} on input paths with the given link options.
   */
  public static vendor.google.common.base.Predicate<Path> isRegularFile(LinkOption... options) {
    final LinkOption[] optionsCopy = options.clone();
