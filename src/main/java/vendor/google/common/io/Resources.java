...
import vendor.google.common.base.Charsets;
...
public final class Resources {
  ...
  /**
   * Returns a {@link vendor.google.common.io.ByteSource} that reads from the given URL.
   *
   * @since 14.0
   */
  public static vendor.google.common.io.ByteSource asByteSource(URL url) {
  ...
  /**
   * Returns a {@link vendor.google.common.io.CharSource} that reads from the given URL using the given character set.
   *
   * @since 14.0
   */
   ...
   *
   * @param url the URL to read from
   * @param charset the charset used to decode the input stream; see {@link vendor.google.common.base.Charsets} for helpful
  ...
  public static <T> T readLines(URL url, Charset charset, vendor.google.common.io.LineProcessor<T> callback)
      throws IOException {
