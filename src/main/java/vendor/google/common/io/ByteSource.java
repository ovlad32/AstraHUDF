...
import vendor.google.common.hash.Funnels;
import vendor.google.common.hash.HashCode;
import vendor.google.common.hash.HashFunction;
import vendor.google.common.hash.Hasher;
...
public abstract class ByteSource {
  ...
  public boolean isEmpty() throws IOException {
    vendor.google.common.base.Optional<Long> sizeIfKnown = sizeIfKnown();
   ...
   *
   * <p>The default implementation returns {@link vendor.google.common.base.Optional#absent}. Some sources, such as a file,
  ...
  public vendor.google.common.base.Optional<Long> sizeIfKnown() {
  ...
  public byte[] read() throws IOException {
    ...
    try {
      InputStream in = closer.register(openStream());
      vendor.google.common.base.Optional<Long> size = sizeIfKnown();
  ...
  public <T> T read(vendor.google.common.io.ByteProcessor<T> processor) throws IOException {
   ...
   * @throws IOException if an I/O error occurs while reading from this source
   */
  public vendor.google.common.hash.HashCode hash(vendor.google.common.hash.HashFunction hashFunction) throws IOException {
  ...
  private final class SlicedByteSource extends ByteSource {
    ...
    @Override
    public vendor.google.common.base.Optional<Long> sizeIfKnown() {
      vendor.google.common.base.Optional<Long> optionalUnslicedSize = ByteSource.this.sizeIfKnown();
      if (optionalUnslicedSize.isPresent()) {
        long unslicedSize = optionalUnslicedSize.get();
        long off = Math.min(offset, unslicedSize);
        return vendor.google.common.base.Optional.of(Math.min(length, unslicedSize - off));
      }
      return vendor.google.common.base.Optional.absent();
    }
  ...
  private static class ByteArrayByteSource extends ByteSource {
    ...
    @Override
    public vendor.google.common.base.Optional<Long> sizeIfKnown() {
      return vendor.google.common.base.Optional.of((long) length);
    }
  ...
  private static final class ConcatenatedByteSource extends ByteSource {
    ...
    @Override
    public InputStream openStream() throws IOException {
      return new vendor.google.common.io.MultiInputStream(sources.iterator());
    }
    ...
    public vendor.google.common.base.Optional<Long> sizeIfKnown() {
      ...
      long result = 0L;
      for (ByteSource source : sources) {
        vendor.google.common.base.Optional<Long> sizeIfKnown = source.sizeIfKnown();
        if (!sizeIfKnown.isPresent()) {
          return vendor.google.common.base.Optional.absent();
        }
        ...
        if (result < 0) {
          ...
          return vendor.google.common.base.Optional.of(Long.MAX_VALUE);
        }
      }
