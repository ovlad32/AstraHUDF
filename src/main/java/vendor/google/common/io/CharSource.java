...
package vendor.google.common.io;

import static vendor.google.common.base.Preconditions.checkNotNull;

import vendor.google.common.collect.Streams;
...
import vendor.google.common.base.Ascii;
import vendor.google.common.base.Optional;
import vendor.google.common.base.Preconditions;
import vendor.google.common.base.Splitter;
import vendor.google.common.collect.AbstractIterator;
import vendor.google.common.collect.ImmutableList;
import vendor.google.common.collect.Lists;
 ...
 *
 * <p>Any {@link vendor.google.common.io.ByteSource} containing text encoded with a specific {@linkplain Charset character
 * encoding} may be viewed as a {@code CharSource} using {@link vendor.google.common.io.ByteSource#asCharSource(Charset)}.
 *
 * @since 14.0
 * @author Colin Decker
 */
...
public abstract class CharSource {
  ...
  /**
   * Returns a {@link vendor.google.common.io.ByteSource} view of this char source that encodes chars read from this source
   * as bytes using the given {@link Charset}.
   *
   * <p>If {@link vendor.google.common.io.ByteSource#asCharSource} is called on the returned source with the same charset,
  ...
  public vendor.google.common.io.ByteSource asByteSource(Charset charset) {
   ...
   *
   * <p>The default implementation returns {@link vendor.google.common.base.Optional#absent}. Some sources, such as a {@code
   ...
   */
  @vendor.google.common.annotations.Beta
  public vendor.google.common.base.Optional<Long> lengthIfKnown() {
    return vendor.google.common.base.Optional.absent();
  }
  ...
  public long length() throws IOException {
    vendor.google.common.base.Optional<Long> lengthIfKnown = lengthIfKnown();
  ...
  public long copyTo(Appendable appendable) throws IOException {
    ...
    try {
      Reader reader = closer.register(openStream());
      return vendor.google.common.io.CharStreams.copy(reader, appendable);
    } catch (Throwable e) {
      throw closer.rethrow(e);
    } finally {
      closer.close();
  ...
  public long copyTo(CharSink sink) throws IOException {
    ...
    try {
      ...
      return vendor.google.common.io.CharStreams.copy(reader, writer);
    } catch (Throwable e) {
      throw closer.rethrow(e);
    } finally {
      closer.close();
  ...
  public String read() throws IOException {
    ...
    try {
      Reader reader = closer.register(openStream());
      return vendor.google.common.io.CharStreams.toString(reader);
    } catch (Throwable e) {
      throw closer.rethrow(e);
    } finally {
      closer.close();
   ...
   * @throws IOException if an I/O error occurs while reading from this source
   */
  public vendor.google.common.collect.ImmutableList<String> readLines() throws IOException {
    Closer closer = Closer.create();
    try {
      BufferedReader reader = closer.register(openBufferedStream());
      ...
      return vendor.google.common.collect.ImmutableList.copyOf(result);
    } catch (Throwable e) {
      throw closer.rethrow(e);
    } finally {
      closer.close();
  ...
  public static CharSource concat(Iterator<? extends CharSource> sources) {
    return concat(vendor.google.common.collect.ImmutableList.copyOf(sources));
  }
  ...
  private static class CharSequenceCharSource extends CharSource {
    ...
    private static final vendor.google.common.base.Splitter LINE_SPLITTER = Splitter.onPattern("\r\n|\n|\r");
    ...
    @Override
    public vendor.google.common.base.Optional<Long> lengthIfKnown() {
      return vendor.google.common.base.Optional.of((long) seq.length());
    }
    ...
    @Override
    public vendor.google.common.collect.ImmutableList<String> readLines() {
  ...
  private static final class ConcatenatedCharSource extends CharSource {
    ...
    public vendor.google.common.base.Optional<Long> lengthIfKnown() {
      long result = 0L;
      for (CharSource source : sources) {
        vendor.google.common.base.Optional<Long> lengthIfKnown = source.lengthIfKnown();
        if (!lengthIfKnown.isPresent()) {
          return vendor.google.common.base.Optional.absent();
        }
