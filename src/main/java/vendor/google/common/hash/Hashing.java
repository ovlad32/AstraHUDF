...
import vendor.google.common.primitives.UnsignedLongs;

/**
 * Static methods to obtain {@link vendor.google.common.hash.HashFunction} instances, and other static hashing-related
 * utilities.
 *
...
public final class Hashing {
   ...
   * for {@code minimumBits}, will return identically-behaving {@link vendor.google.common.hash.HashFunction} instances.
   *
   * @param minimumBits a positive integer (can be arbitrarily large)
   * @return a hash function, described above, that produces hash codes of length {@code
   *     minimumBits} or greater
   */
  public static vendor.google.common.hash.HashFunction goodFastHash(int minimumBits) {
    int bits = checkPositiveAndMakeMultipleOf32(minimumBits);

    if (bits == 32) {
      return vendor.google.common.hash.Murmur3_32HashFunction.GOOD_FAST_HASH_32;
    }
    if (bits <= 128) {
    ...
    vendor.google.common.hash.HashFunction[] hashFunctions = new vendor.google.common.hash.HashFunction[hashFunctionsNeeded];
   ...
   */
  public static vendor.google.common.hash.HashFunction murmur3_32(int seed) {
    return new vendor.google.common.hash.Murmur3_32HashFunction(seed);
  }
   ...
   * <p>The exact C++ equivalent is the MurmurHash3_x86_32 function (Murmur3A).
   */
  public static vendor.google.common.hash.HashFunction murmur3_32() {
    return vendor.google.common.hash.Murmur3_32HashFunction.MURMUR3_32;
  }
   ...
   */
  public static vendor.google.common.hash.HashFunction murmur3_128(int seed) {
   ...
   * <p>The exact C++ equivalent is the MurmurHash3_x64_128 function (Murmur3F).
   */
  public static vendor.google.common.hash.HashFunction murmur3_128() {
   ...
   * @since 15.0
   */
  public static vendor.google.common.hash.HashFunction sipHash24() {
   ...
   * @since 15.0
   */
  public static vendor.google.common.hash.HashFunction sipHash24(long k0, long k1) {
   ...
   */
  @Deprecated
  public static vendor.google.common.hash.HashFunction md5() {
    return Md5Holder.MD5;
  }

  private static class Md5Holder {
    static final vendor.google.common.hash.HashFunction MD5 = new vendor.google.common.hash.MessageDigestHashFunction("MD5", "Hashing.md5()");
  }
   ...
   */
  @Deprecated
  public static vendor.google.common.hash.HashFunction sha1() {
    return Sha1Holder.SHA_1;
  }

  private static class Sha1Holder {
    static final vendor.google.common.hash.HashFunction SHA_1 = new vendor.google.common.hash.MessageDigestHashFunction("SHA-1", "Hashing.sha1()");
  }

  /** Returns a hash function implementing the SHA-256 algorithm (256 hash bits). */
  public static vendor.google.common.hash.HashFunction sha256() {
    return Sha256Holder.SHA_256;
  }

  private static class Sha256Holder {
    static final vendor.google.common.hash.HashFunction SHA_256 =
        new vendor.google.common.hash.MessageDigestHashFunction("SHA-256", "Hashing.sha256()");
  }
   ...
   * @since 19.0
   */
  public static vendor.google.common.hash.HashFunction sha384() {
    return Sha384Holder.SHA_384;
  }

  private static class Sha384Holder {
    static final vendor.google.common.hash.HashFunction SHA_384 =
        new vendor.google.common.hash.MessageDigestHashFunction("SHA-384", "Hashing.sha384()");
  }

  /** Returns a hash function implementing the SHA-512 algorithm (512 hash bits). */
  public static vendor.google.common.hash.HashFunction sha512() {
    return Sha512Holder.SHA_512;
  }

  private static class Sha512Holder {
    static final vendor.google.common.hash.HashFunction SHA_512 =
        new vendor.google.common.hash.MessageDigestHashFunction("SHA-512", "Hashing.sha512()");
  }
   ...
   * @since 20.0
   */
  public static vendor.google.common.hash.HashFunction hmacMd5(Key key) {
   ...
   * @since 20.0
   */
  public static vendor.google.common.hash.HashFunction hmacMd5(byte[] key) {
   ...
   * @since 20.0
   */
  public static vendor.google.common.hash.HashFunction hmacSha1(Key key) {
   ...
   * @since 20.0
   */
  public static vendor.google.common.hash.HashFunction hmacSha1(byte[] key) {
   ...
   * @since 20.0
   */
  public static vendor.google.common.hash.HashFunction hmacSha256(Key key) {
   ...
   * @since 20.0
   */
  public static vendor.google.common.hash.HashFunction hmacSha256(byte[] key) {
   ...
   * @since 20.0
   */
  public static vendor.google.common.hash.HashFunction hmacSha512(Key key) {
   ...
   * @since 20.0
   */
  public static vendor.google.common.hash.HashFunction hmacSha512(byte[] key) {
   ...
   * @since 18.0
   */
  public static vendor.google.common.hash.HashFunction crc32c() {
   ...
   * @since 14.0
   */
  public static vendor.google.common.hash.HashFunction crc32() {
   ...
   * @since 14.0
   */
  public static vendor.google.common.hash.HashFunction adler32() {
  ...
  enum ChecksumType implements ImmutableSupplier<Checksum> {
    ...
    public final vendor.google.common.hash.HashFunction hashFunction;

    ChecksumType(String toString) {
      this.hashFunction = new vendor.google.common.hash.ChecksumHashFunction(this, 32, toString);
    }
  }
   ...
   * @since 20.0
   */
  public static vendor.google.common.hash.HashFunction farmHashFingerprint64() {
   ...
   * @since 19.0
   */
  public static vendor.google.common.hash.HashFunction concatenating(
          vendor.google.common.hash.HashFunction first, vendor.google.common.hash.HashFunction second, vendor.google.common.hash.HashFunction... rest) {
    // We can't use Lists.asList() here because there's no hash->collect dependency
    List<vendor.google.common.hash.HashFunction> list = new ArrayList<>();
    list.add(first);
    list.add(second);
    list.addAll(Arrays.asList(rest));
    return new ConcatenatedHashFunction(list.toArray(new vendor.google.common.hash.HashFunction[0]));
  }
   ...
   * @since 19.0
   */
  public static vendor.google.common.hash.HashFunction concatenating(Iterable<vendor.google.common.hash.HashFunction> hashFunctions) {
    checkNotNull(hashFunctions);
    // We can't use Iterables.toArray() here because there's no hash->collect dependency
    List<vendor.google.common.hash.HashFunction> list = new ArrayList<>();
    for (vendor.google.common.hash.HashFunction hashFunction : hashFunctions) {
  ...
  private static final class ConcatenatedHashFunction extends vendor.google.common.hash.AbstractCompositeHashFunction {

    private ConcatenatedHashFunction(vendor.google.common.hash.HashFunction... functions) {
      super(functions);
      for (vendor.google.common.hash.HashFunction function : functions) {
        checkArgument(
            function.bits() % 8 == 0,
