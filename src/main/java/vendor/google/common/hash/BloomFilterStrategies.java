...
import vendor.google.common.math.LongMath;
...
enum BloomFilterStrategies implements BloomFilter.Strategy {
  ...
  MURMUR128_MITZ_32() {
    ...
    public <T> boolean put(
            T object, vendor.google.common.hash.Funnel<? super T> funnel, int numHashFunctions, LockFreeBitArray bits) {
      long bitSize = bits.bitSize();
      long hash64 = vendor.google.common.hash.Hashing.murmur3_128().hashObject(object, funnel).asLong();
  ...
  /**
   * This strategy uses all 128 bits of {@link vendor.google.common.hash.Hashing#murmur3_128} when hashing. It looks different
  ...
  MURMUR128_MITZ_64() {
    ...
    public <T> boolean put(
            T object, vendor.google.common.hash.Funnel<? super T> funnel, int numHashFunctions, LockFreeBitArray bits) {
      long bitSize = bits.bitSize();
      byte[] bytes = vendor.google.common.hash.Hashing.murmur3_128().hashObject(object, funnel).getBytesInternal();
    ...
    private /* static */ long lowerEight(byte[] bytes) {
      return vendor.google.common.primitives.Longs.fromBytes(
