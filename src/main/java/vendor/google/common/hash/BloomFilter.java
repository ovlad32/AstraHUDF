...
import vendor.google.common.math.DoubleMath;
import vendor.google.common.primitives.SignedBytes;
 ...
 */
@Beta
public final class BloomFilter<T> implements vendor.google.common.base.Predicate<T>, Serializable {
  /**
  ...
  public void writeTo(OutputStream out) throws IOException {
    ...
    dout.writeByte(vendor.google.common.primitives.UnsignedBytes.checkedCast(numHashFunctions)); // note: checked at the c'tor
