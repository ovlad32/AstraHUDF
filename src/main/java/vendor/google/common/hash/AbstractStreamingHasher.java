...
abstract class AbstractStreamingHasher extends vendor.google.common.hash.AbstractHasher {
  ...
  @Override
  public final vendor.google.common.hash.Hasher putBytes(byte[] bytes, int off, int len) {
    return putBytesInternal(ByteBuffer.wrap(bytes, off, len).order(ByteOrder.LITTLE_ENDIAN));
  }

  @Override
  public final vendor.google.common.hash.Hasher putBytes(ByteBuffer readBuffer) {
  ...
  private vendor.google.common.hash.Hasher putBytesInternal(ByteBuffer readBuffer) {
  ...
  @Override
  public final vendor.google.common.hash.Hasher putByte(byte b) {
    buffer.put(b);
    munchIfFull();
    return this;
  }
  ...
  @Override
  public final vendor.google.common.hash.Hasher putShort(short s) {
    buffer.putShort(s);
    munchIfFull();
    return this;
  }
  ...
  @Override
  public final vendor.google.common.hash.Hasher putChar(char c) {
    buffer.putChar(c);
    munchIfFull();
    return this;
  }
  ...
  @Override
  public final vendor.google.common.hash.Hasher putInt(int i) {
    buffer.putInt(i);
    munchIfFull();
    return this;
  }
