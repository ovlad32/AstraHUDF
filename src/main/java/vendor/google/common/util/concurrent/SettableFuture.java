...
/**
 * A {@link vendor.google.common.util.concurrent.ListenableFuture} whose result can be set by a {@link #set(Object)}, {@link
 * #setException(Throwable)} or {@link #setFuture(vendor.google.common.util.concurrent.ListenableFuture)} call. It can also, like any
 ...
 * vendor.google.common.util.concurrent.AbstractFuture}, which offers an extensible version of the API.
 *
 * @author Sven Mawson
