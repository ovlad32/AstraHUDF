...
public abstract class AbstractScheduledService implements Service {
  ...
  public abstract static class Scheduler {
    ...
    public static Scheduler newFixedDelaySchedule(
      ...
      return new Scheduler() {
        ...
        public Future<?> schedule(
                vendor.google.common.util.concurrent.AbstractService service, ScheduledExecutorService executor, Runnable task) {
    ...
    abstract Future<?> schedule(
            vendor.google.common.util.concurrent.AbstractService service, ScheduledExecutorService executor, Runnable runnable);

    private Scheduler() {}
  }

  /* use AbstractService for state management */
  private final vendor.google.common.util.concurrent.AbstractService delegate = new ServiceDelegate();

  @WeakOuter
  private final class ServiceDelegate extends vendor.google.common.util.concurrent.AbstractService {
  ...
  public abstract static class CustomScheduler extends Scheduler {
    ...
    private class ReschedulableCallable extends ForwardingFuture<Void> implements Callable<Void> {
       ...
       * properly.
       */
      private final vendor.google.common.util.concurrent.AbstractService service;
