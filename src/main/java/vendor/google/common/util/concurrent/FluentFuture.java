...
/**
 * A {@link vendor.google.common.util.concurrent.ListenableFuture} that supports fluent chains of operations. For example:
 *
 * <pre>{@code
 ...
 * own subclass of {@link vendor.google.common.util.concurrent.ListenableFuture}, complete with a method like {@link #from} to adapt an
