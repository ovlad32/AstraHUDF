...
public class CycleDetectingLockFactory {
  ...
  private static final ConcurrentMap<Class<? extends Enum>, Map<? extends Enum, LockGraphNode>>
      lockGraphNodesPerType = new vendor.google.common.collect.MapMaker().weakKeys().makeMap();
  ...
  static <E extends Enum<E>> Map<E, LockGraphNode> createNodes(Class<E> clazz) {
    ...
    ArrayList<LockGraphNode> nodes = vendor.google.common.collect.Lists.newArrayListWithCapacity(numKeys);
  ...
  private static class ExampleStackTrace extends IllegalStateException {
    ...
    static final vendor.google.common.collect.ImmutableSet<String> EXCLUDED_CLASS_NAMES =
        ImmutableSet.of(
  ...
  private static class LockGraphNode {
    ...
    final Map<LockGraphNode, ExampleStackTrace> allowedPriorLocks =
        new vendor.google.common.collect.MapMaker().weakKeys().makeMap();
