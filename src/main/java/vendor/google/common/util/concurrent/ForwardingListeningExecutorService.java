...
public abstract class ForwardingListeningExecutorService extends ForwardingExecutorService
    implements vendor.google.common.util.concurrent.ListeningExecutorService {
  ...
  @Override
  public <T> vendor.google.common.util.concurrent.ListenableFuture<T> submit(Callable<T> task) {
    return delegate().submit(task);
  }

  @Override
  public vendor.google.common.util.concurrent.ListenableFuture<?> submit(Runnable task) {
    return delegate().submit(task);
  }
