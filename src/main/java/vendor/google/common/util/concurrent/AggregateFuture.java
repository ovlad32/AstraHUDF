...
abstract class AggregateFuture<InputT, OutputT> extends AbstractFuture.TrustedFuture<OutputT> {
  ...
  protected final void afterDone() {
    ...
    if (localRunningState != null) {
      ...
      vendor.google.common.collect.ImmutableCollection<? extends ListenableFuture<? extends InputT>> futures =
  ...
  protected String pendingToString() {
    ...
    vendor.google.common.collect.ImmutableCollection<? extends ListenableFuture<? extends InputT>> localFutures =
        localRunningState.futures;
  ...
  abstract class RunningState extends AggregateFutureState implements Runnable {
    private vendor.google.common.collect.ImmutableCollection<? extends ListenableFuture<? extends InputT>> futures;
