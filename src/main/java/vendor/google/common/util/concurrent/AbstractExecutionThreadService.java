 ...
 * methods. This class uses a single thread to execute the service; consider {@link vendor.google.common.util.concurrent.AbstractService}
...
@Beta
@GwtIncompatible
public abstract class AbstractExecutionThreadService implements vendor.google.common.util.concurrent.Service {
  private static final Logger logger =
      Logger.getLogger(AbstractExecutionThreadService.class.getName());

  /* use AbstractService for state management */
  private final vendor.google.common.util.concurrent.Service delegate =
      new AbstractService() {
        @Override
        protected final void doStart() {
          Executor executor =
              vendor.google.common.util.concurrent.MoreExecutors.renamingDecorator(
                  executor(),
                  new Supplier<String>() {
                    @Override
                    public String get() {
  ...
  @Override
  public final vendor.google.common.util.concurrent.Service startAsync() {
    delegate.startAsync();
    return this;
  }
