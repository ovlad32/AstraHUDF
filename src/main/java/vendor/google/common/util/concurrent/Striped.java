...
import vendor.google.common.collect.MapMaker;
...
public abstract class Striped<L> {
  ...
  private abstract static class PowerOfTwoStriped<L> extends Striped<L> {
    ...
    PowerOfTwoStriped(int stripes) {
      ...
      this.mask = stripes > vendor.google.common.primitives.Ints.MAX_POWER_OF_TWO ? ALL_SET : ceilToPowerOfTwo(stripes) - 1;
    }
