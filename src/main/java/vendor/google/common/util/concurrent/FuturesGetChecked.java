...
/** Static methods used to implement {@link vendor.google.common.util.concurrent.Futures#getChecked(Future, Class)}. */
@GwtIncompatible
final class FuturesGetChecked {
  ...
  /** Implementation of {@link vendor.google.common.util.concurrent.Futures#getChecked(Future, Class)}. */
  @CanIgnoreReturnValue
  ...
  private static final vendor.google.common.collect.Ordering<Constructor<?>> WITH_STRING_PARAM_FIRST =
      Ordering.natural()
          .onResultOf(
