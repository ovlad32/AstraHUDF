...
public final class JdkFutureAdapters {
  /**
   * Assigns a thread to the given {@link Future} to provide {@link vendor.google.common.util.concurrent.ListenableFuture} functionality.
   *
   * <p><b>Warning:</b> If the input future does not already implement {@code ListenableFuture}, the
   * returned future will emulate {@link vendor.google.common.util.concurrent.ListenableFuture#addListener} by taking a thread from an
   ...
   * ListenableFutureTask}, {@link vendor.google.common.util.concurrent.AbstractFuture}, and other utilities over creating plain {@code
   * Future} instances to be upgraded to {@code ListenableFuture} after the fact.
   */
  public static <V> vendor.google.common.util.concurrent.ListenableFuture<V> listenInPoolThread(Future<V> future) {
    if (future instanceof vendor.google.common.util.concurrent.ListenableFuture) {
      return (vendor.google.common.util.concurrent.ListenableFuture<V>) future;
    }
    return new ListenableFutureAdapter<V>(future);
  }

  /**
   * Submits a blocking task for the given {@link Future} to provide {@link vendor.google.common.util.concurrent.ListenableFuture}
   * functionality.
   *
   * <p><b>Warning:</b> If the input future does not already implement {@code ListenableFuture}, the
   * returned future will emulate {@link vendor.google.common.util.concurrent.ListenableFuture#addListener} by submitting a task to the
   ...
   * @since 12.0
   */
  public static <V> vendor.google.common.util.concurrent.ListenableFuture<V> listenInPoolThread(Future<V> future, Executor executor) {
  ...
  /**
   * An adapter to turn a {@link Future} into a {@link vendor.google.common.util.concurrent.ListenableFuture}. This will wait on the
  ...
  private static class ListenableFutureAdapter<V> extends ForwardingFuture<V>
    ...
    private final vendor.google.common.util.concurrent.ExecutionList executionList = new ExecutionList();
