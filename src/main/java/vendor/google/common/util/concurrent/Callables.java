...
public final class Callables {
   ...
   *
   * <p>The {@link AsyncCallable} returns the {@link vendor.google.common.util.concurrent.ListenableFuture} resulting from {@link
   * vendor.google.common.util.concurrent.ListeningExecutorService#submit(Callable)}.
   *
   * @since 20.0
   */
  @Beta
   ...
   */
  @vendor.google.common.annotations.GwtIncompatible // threads
