...
@Beta
@GwtIncompatible
public abstract class AbstractIdleService implements vendor.google.common.util.concurrent.Service {
  ...
  private final vendor.google.common.util.concurrent.Service delegate = new DelegateService();

  @WeakOuter
  private final class DelegateService extends AbstractService {
    @Override
    protected final void doStart() {
      vendor.google.common.util.concurrent.MoreExecutors.renamingDecorator(executor(), threadNameSupplier)
          .execute(
              new Runnable() {
                @Override
                public void run() {
