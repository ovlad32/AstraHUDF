...
abstract class WrappingExecutorService implements ExecutorService {
   ...
   */
  private <T> vendor.google.common.collect.ImmutableList<Callable<T>> wrapTasks(Collection<? extends Callable<T>> tasks) {
    vendor.google.common.collect.ImmutableList.Builder<Callable<T>> builder = ImmutableList.builder();
