...
import static vendor.google.common.util.concurrent.Uninterruptibles.getUninterruptibly;

import vendor.google.common.base.Function;
import vendor.google.common.base.MoreObjects;
 ...
 *
 * <p>Many of these methods use the {@link vendor.google.common.util.concurrent.ListenableFuture} API; consult the Guava User Guide
 * article on <a href="https://github.com/google/guava/wiki/ListenableFutureExplained">{@code
 * ListenableFuture}</a>.
 *
 * <p>The main purpose of {@code ListenableFuture} is to help you chain together a graph of
 * asynchronous operations. You can chain them together manually with calls to methods like {@link
 * Futures#transform(vendor.google.common.util.concurrent.ListenableFuture, Function, Executor) Futures.transform}, but you will often
 ...
 * @since 1.0
 */
@vendor.google.common.annotations.GwtCompatible(emulated = true)
public final class Futures extends GwtFuturesCatchingSpecialization {
   ...
   */
  public static <V> vendor.google.common.util.concurrent.ListenableFuture<V> immediateFuture(@Nullable V value) {
    if (value == null) {
      // This cast is safe because null is assignable to V for all V (i.e. it is covariant)
      @SuppressWarnings({"unchecked", "rawtypes"})
      vendor.google.common.util.concurrent.ListenableFuture<V> typedNull = (vendor.google.common.util.concurrent.ListenableFuture) ImmediateFuture.ImmediateSuccessfulFuture.NULL;
      return typedNull;
    }
   ...
   */
  public static <V> vendor.google.common.util.concurrent.ListenableFuture<V> immediateFailedFuture(Throwable throwable) {
   ...
   * @since 14.0
   */
  public static <V> vendor.google.common.util.concurrent.ListenableFuture<V> immediateCancelledFuture() {
  ...
  public static <O> vendor.google.common.util.concurrent.ListenableFuture<O> submitAsync(AsyncCallable<O> callable, Executor executor) {
   ...
   */
  @vendor.google.common.annotations.Beta
  @vendor.google.common.annotations.GwtIncompatible // java.util.concurrent.ScheduledExecutorService
  @SuppressWarnings("GoodTime") // should accept a java.time.Duration
  public static <O> vendor.google.common.util.concurrent.ListenableFuture<O> scheduleAsync(
   ...
   * the discussion in the {@link vendor.google.common.util.concurrent.ListenableFuture#addListener ListenableFuture.addListener}
  ...
  public static <V, X extends Throwable> vendor.google.common.util.concurrent.ListenableFuture<V> catching(
      vendor.google.common.util.concurrent.ListenableFuture<? extends V> input,
  ...
  @vendor.google.common.annotations.Beta
  @Partially.GwtIncompatible("AVAILABLE but requires exceptionType to be Throwable.class")
  public static <V, X extends Throwable> vendor.google.common.util.concurrent.ListenableFuture<V> catchingAsync(
      vendor.google.common.util.concurrent.ListenableFuture<? extends V> input,
      Class<X> exceptionType,
  ...
  @vendor.google.common.annotations.GwtIncompatible // java.util.concurrent.ScheduledExecutorService
  @SuppressWarnings("GoodTime") // should accept a java.time.Duration
  public static <V> vendor.google.common.util.concurrent.ListenableFuture<V> withTimeout(
      vendor.google.common.util.concurrent.ListenableFuture<V> delegate,
      long time,
      TimeUnit unit,
   ...
   */
  @vendor.google.common.annotations.Beta
  public static <I, O> vendor.google.common.util.concurrent.ListenableFuture<O> transformAsync(
      vendor.google.common.util.concurrent.ListenableFuture<I> input,
   ...
   */
  @vendor.google.common.annotations.Beta
  public static <I, O> vendor.google.common.util.concurrent.ListenableFuture<O> transform(
          vendor.google.common.util.concurrent.ListenableFuture<I> input, Function<? super I, ? extends O> function, Executor executor) {
    return AbstractTransformFuture.create(input, function, executor);
  }

  /**
   * Like {@link #transform(vendor.google.common.util.concurrent.ListenableFuture, Function, Executor)} except that the transformation
   ...
   */
  @vendor.google.common.annotations.Beta
  @vendor.google.common.annotations.GwtIncompatible // TODO
  ...
  @vendor.google.common.annotations.Beta
  @SafeVarargs
  public static <V> vendor.google.common.util.concurrent.ListenableFuture<List<V>> allAsList(vendor.google.common.util.concurrent.ListenableFuture<? extends V>... futures) {
    return new CollectionFuture.ListFuture<V>(vendor.google.common.collect.ImmutableList.copyOf(futures), true);
  }
   ...
   */
  @vendor.google.common.annotations.Beta
  public static <V> vendor.google.common.util.concurrent.ListenableFuture<List<V>> allAsList(
      Iterable<? extends vendor.google.common.util.concurrent.ListenableFuture<? extends V>> futures) {
    return new CollectionFuture.ListFuture<V>(vendor.google.common.collect.ImmutableList.copyOf(futures), true);
  }
  ...
  @vendor.google.common.annotations.Beta
  @SafeVarargs
  public static <V> FutureCombiner<V> whenAllComplete(vendor.google.common.util.concurrent.ListenableFuture<? extends V>... futures) {
    return new FutureCombiner<V>(false, vendor.google.common.collect.ImmutableList.copyOf(futures));
  }
  ...
  @vendor.google.common.annotations.Beta
  @SafeVarargs
  public static <V> FutureCombiner<V> whenAllSucceed(vendor.google.common.util.concurrent.ListenableFuture<? extends V>... futures) {
    return new FutureCombiner<V>(true, vendor.google.common.collect.ImmutableList.copyOf(futures));
  }
  ...
  public static final class FutureCombiner<V> {
    ...
    private final vendor.google.common.collect.ImmutableList<vendor.google.common.util.concurrent.ListenableFuture<? extends V>> futures;

    private FutureCombiner(
        boolean allMustSucceed, vendor.google.common.collect.ImmutableList<vendor.google.common.util.concurrent.ListenableFuture<? extends V>> futures) {
      this.allMustSucceed = allMustSucceed;
      this.futures = futures;
    }

    /**
     * Creates the {@link vendor.google.common.util.concurrent.ListenableFuture} which will return the result of calling {@link
     ...
     */
    public <C> vendor.google.common.util.concurrent.ListenableFuture<C> callAsync(AsyncCallable<C> combiner, Executor executor) {
    ...
    public <C> vendor.google.common.util.concurrent.ListenableFuture<C> call(Callable<C> combiner, Executor executor) {
      return new CombinedFuture<C>(futures, allMustSucceed, executor, combiner);
    }

    /**
     * Creates the {@link vendor.google.common.util.concurrent.ListenableFuture} which will return the result of running {@code combiner}
     ...
     * @since 23.6
     */
    public vendor.google.common.util.concurrent.ListenableFuture<?> run(final Runnable combiner, Executor executor) {
      return call(
          new Callable<Void>() {
            @Override
   ...
   */
  @vendor.google.common.annotations.Beta
  public static <V> vendor.google.common.util.concurrent.ListenableFuture<V> nonCancellationPropagating(vendor.google.common.util.concurrent.ListenableFuture<V> future) {
    if (future.isDone()) {
      return future;
    }
  ...
  private static final class NonCancellationPropagatingFuture<V>
      extends vendor.google.common.util.concurrent.AbstractFuture.TrustedFuture<V> implements Runnable {
    private vendor.google.common.util.concurrent.ListenableFuture<V> delegate;

    NonCancellationPropagatingFuture(final vendor.google.common.util.concurrent.ListenableFuture<V> delegate) {
    ...
    public void run() {
      ...
      vendor.google.common.util.concurrent.ListenableFuture<V> localDelegate = delegate;
  ...
  @vendor.google.common.annotations.Beta
  @SafeVarargs
  public static <V> vendor.google.common.util.concurrent.ListenableFuture<List<V>> successfulAsList(
      vendor.google.common.util.concurrent.ListenableFuture<? extends V>... futures) {
    return new CollectionFuture.ListFuture<V>(vendor.google.common.collect.ImmutableList.copyOf(futures), false);
  }
   ...
   */
  @vendor.google.common.annotations.Beta
  public static <T> vendor.google.common.collect.ImmutableList<vendor.google.common.util.concurrent.ListenableFuture<T>> inCompletionOrder(
      Iterable<? extends vendor.google.common.util.concurrent.ListenableFuture<? extends T>> futures) {
    // Can't use Iterables.toArray because it's not gwt compatible
    final Collection<vendor.google.common.util.concurrent.ListenableFuture<? extends T>> collection;
    if (futures instanceof Collection) {
      collection = (Collection<vendor.google.common.util.concurrent.ListenableFuture<? extends T>>) futures;
    } else {
      collection = vendor.google.common.collect.ImmutableList.copyOf(futures);
    }
    @SuppressWarnings("unchecked")
    vendor.google.common.util.concurrent.ListenableFuture<? extends T>[] copy =
        (vendor.google.common.util.concurrent.ListenableFuture<? extends T>[])
            collection.toArray(new vendor.google.common.util.concurrent.ListenableFuture[collection.size()]);
    final InCompletionOrderState<T> state = new InCompletionOrderState<>(copy);
    vendor.google.common.collect.ImmutableList.Builder<vendor.google.common.util.concurrent.AbstractFuture<T>> delegatesBuilder = vendor.google.common.collect.ImmutableList.builder();
    for (int i = 0; i < copy.length; i++) {
      delegatesBuilder.add(new InCompletionOrderFuture<T>(state));
    }

    final vendor.google.common.collect.ImmutableList<vendor.google.common.util.concurrent.AbstractFuture<T>> delegates = delegatesBuilder.build();
    for (int i = 0; i < copy.length; i++) {
      final int localI = i;
      copy[i].addListener(
          new Runnable() {
    ...
    @SuppressWarnings("unchecked")
    vendor.google.common.collect.ImmutableList<vendor.google.common.util.concurrent.ListenableFuture<T>> delegatesCast = (vendor.google.common.collect.ImmutableList) delegates;
  ...
  // cancelled.
  private static final class InCompletionOrderFuture<T> extends vendor.google.common.util.concurrent.AbstractFuture<T> {
  ...
  private static final class InCompletionOrderState<T> {
    ...
    private final vendor.google.common.util.concurrent.ListenableFuture<? extends T>[] inputFutures;
    private volatile int delegateIndex = 0;

    private InCompletionOrderState(vendor.google.common.util.concurrent.ListenableFuture<? extends T>[] inputFutures) {
    ...
    private void recordInputCompletion(
      ...
      vendor.google.common.util.concurrent.ListenableFuture<? extends T> inputFuture = inputFutures[inputFutureIndex];
    ...
    private void recordCompletion() {
      if (incompleteOutputCount.decrementAndGet() == 0 && wasCancelled) {
        for (vendor.google.common.util.concurrent.ListenableFuture<?> toCancel : inputFutures) {
          if (toCancel != null) {
   ...
   * vendor.google.common.util.concurrent.ListenableFuture#addListener addListener}.
   *
  ...
  public static <V> void addCallback(
      final vendor.google.common.util.concurrent.ListenableFuture<V> future,
      final vendor.google.common.util.concurrent.FutureCallback<? super V> callback,
      Executor executor) {
    Preconditions.checkNotNull(callback);
    future.addListener(new CallbackListener<V>(future, callback), executor);
  }

  /** See {@link #addCallback(ListenableFuture, vendor.google.common.util.concurrent.FutureCallback, Executor)} for behavioral notes. */
   ...
   *       is a checked exception, an {@link vendor.google.common.util.concurrent.UncheckedExecutionException} if the cause is a {@code
   *       RuntimeException}, or an {@link vendor.google.common.util.concurrent.ExecutionError} if the cause is an {@code Error}.
   ...
   * @throws vendor.google.common.util.concurrent.UncheckedExecutionException if {@code get} throws an {@code ExecutionException} with a
   *     {@code RuntimeException} as its cause
   * @throws vendor.google.common.util.concurrent.ExecutionError if {@code get} throws an {@code ExecutionException} with an {@code
   *     Error} as its cause
  ...
  @vendor.google.common.annotations.Beta
  @CanIgnoreReturnValue
  @vendor.google.common.annotations.GwtIncompatible // reflection
   ...
   *       vendor.google.common.util.concurrent.UncheckedExecutionException} (if the cause is an {@code Exception}) or {@link
   *       vendor.google.common.util.concurrent.ExecutionError} (if the cause is an {@code Error}).
   ...
   *
   * @throws vendor.google.common.util.concurrent.UncheckedExecutionException if {@code get} throws an {@code ExecutionException} with an
