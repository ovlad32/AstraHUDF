...
/**
 * Implementation of {@link vendor.google.common.collect.ImmutableSet} backed by a non-empty {@link java.util.EnumSet}.
 *
 * @author Jared Levy
 */
@GwtCompatible(serializable = true, emulated = true)
@SuppressWarnings("serial") // we're overriding default serialization
final class ImmutableEnumSet<E extends Enum<E>> extends vendor.google.common.collect.ImmutableSet<E> {
  @SuppressWarnings("rawtypes") // necessary to compile against Java 8
  static vendor.google.common.collect.ImmutableSet asImmutable(EnumSet set) {
    switch (set.size()) {
      case 0:
