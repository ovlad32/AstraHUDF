...
import vendor.google.common.util.concurrent.AtomicLongMap;
...
public interface Multiset<E> extends Collection<E> {
   ...
   * multiset for every occurrence in {@code c}, see {@link vendor.google.common.collect.Multisets#removeOccurrences(Multiset,
   * Multiset)}.
   *
   ...
   * <p><b>Note:</b> This method ignores how often any element might appear in {@code c}, and only
   * cares whether or not an element appears at all. If you wish to remove one occurrence in this
   * multiset for every occurrence in {@code c}, see {@link vendor.google.common.collect.Multisets#retainOccurrences(Multiset,
   * Multiset)}.
   *
   * <p>This method refines {@link Collection#retainAll} to further specify that it <b>may not</b>
   * throw an exception in response to any of {@code elements} being null or of the wrong type.
   *
   * @see vendor.google.common.collect.Multisets#retainOccurrences(Multiset, Multiset)
   */
  @CanIgnoreReturnValue
  @Override
