...
/**
 * A {@link vendor.google.common.collect.ListMultimap} whose contents will never change, with many other important properties
...
public class ImmutableListMultimap<K, V> extends vendor.google.common.collect.ImmutableMultimap<K, V>
  ...
  public static <K, V> ImmutableListMultimap<K, V> of() {
    return (ImmutableListMultimap<K, V>) vendor.google.common.collect.EmptyImmutableListMultimap.INSTANCE;
  }
   ...
   * @since 2.0
   */
  public static final class Builder<K, V> extends vendor.google.common.collect.ImmutableMultimap.Builder<K, V> {
    /**
    ...
    @CanIgnoreReturnValue
    @Override
    public Builder<K, V> putAll(vendor.google.common.collect.Multimap<? extends K, ? extends V> multimap) {
  ...
  static <K, V> ImmutableListMultimap<K, V> fromMapEntries(
    ...
    vendor.google.common.collect.ImmutableMap.Builder<K, vendor.google.common.collect.ImmutableList<V>> builder =
        new vendor.google.common.collect.ImmutableMap.Builder<>(mapEntries.size());
    int size = 0;

    for (Entry<? extends K, ? extends Collection<? extends V>> entry : mapEntries) {
      K key = entry.getKey();
      Collection<? extends V> values = entry.getValue();
      vendor.google.common.collect.ImmutableList<V> list =
          (valueComparator == null)
              ? vendor.google.common.collect.ImmutableList.copyOf(values)
              : vendor.google.common.collect.ImmutableList.sortedCopyOf(valueComparator, values);
      if (!list.isEmpty()) {
  ...
  ImmutableListMultimap(vendor.google.common.collect.ImmutableMap<K, vendor.google.common.collect.ImmutableList<V>> map, int size) {
    super(map, size);
  }
   ...
   */
  @Override
  public vendor.google.common.collect.ImmutableList<V> get(@Nullable K key) {
    // This cast is safe as its type is known in constructor.
    vendor.google.common.collect.ImmutableList<V> list = (vendor.google.common.collect.ImmutableList<V>) map.get(key);
    return (list == null) ? vendor.google.common.collect.ImmutableList.<V>of() : list;
  }
  ...
  @Deprecated
  @Override
  public vendor.google.common.collect.ImmutableList<V> removeAll(Object key) {
  ...
  @Deprecated
  @Override
  public vendor.google.common.collect.ImmutableList<V> replaceValues(K key, Iterable<? extends V> values) {
    throw new UnsupportedOperationException();
  }
  ...
  private void writeObject(ObjectOutputStream stream) throws IOException {
    ...
    vendor.google.common.collect.Serialization.writeMultimap(this, stream);
  }
  ...
  private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
    ...
    vendor.google.common.collect.ImmutableMap.Builder<Object, vendor.google.common.collect.ImmutableList<Object>> builder = vendor.google.common.collect.ImmutableMap.builder();
    int tmpSize = 0;
    ...
    for (int i = 0; i < keyCount; i++) {
      ...
      vendor.google.common.collect.ImmutableList.Builder<Object> valuesBuilder = vendor.google.common.collect.ImmutableList.builder();
