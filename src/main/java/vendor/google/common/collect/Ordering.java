 ...
 * @since 2.0
 */
@vendor.google.common.annotations.GwtCompatible
public abstract class Ordering<T> implements Comparator<T> {
  ...
  public static <C extends Comparable> Ordering<C> natural() {
    return (Ordering<C>) vendor.google.common.collect.NaturalOrdering.INSTANCE;
  }
  ...
  public static Ordering<Object> usingToString() {
    return vendor.google.common.collect.UsingToStringOrdering.INSTANCE;
  }
  ...
  static class ArbitraryOrdering extends Ordering<Object> {
    ...
    private final ConcurrentMap<Object, Integer> uids =
        vendor.google.common.collect.Platform.tryWeakKeys(new MapMaker()).makeMap();
  ...
  public <S extends T> Ordering<S> reverse() {
    return new vendor.google.common.collect.ReverseOrdering<S>(this);
  }
  ...
  public <S extends T> Ordering<S> nullsLast() {
    return new vendor.google.common.collect.NullsLastOrdering<S>(this);
  }
  ...
  public <F> Ordering<F> onResultOf(Function<F, ? extends T> function) {
    return new vendor.google.common.collect.ByFunctionOrdering<>(function, this);
  }
  ...
  public <U extends T> Ordering<U> compound(Comparator<? super U> secondaryComparator) {
    return new vendor.google.common.collect.CompoundOrdering<U>(this, checkNotNull(secondaryComparator));
  }
  ...
  public static <T> Ordering<T> compound(Iterable<? extends Comparator<? super T>> comparators) {
    return new vendor.google.common.collect.CompoundOrdering<T>(comparators);
  }
   ...
   *
   * <p>Unlike {@link vendor.google.common.collect.Sets#newTreeSet(Iterable)}, this method does not discard elements that are
