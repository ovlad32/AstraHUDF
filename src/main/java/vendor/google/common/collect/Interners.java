...
public final class Interners {
  ...
  public static class InternerBuilder {
     ...
     */
    @vendor.google.common.annotations.GwtIncompatible("java.lang.ref.WeakReference")
  ...
  static final class InternerImpl<E> implements Interner<E> {
    ...
    public E intern(E sample) {
      while (true) {
        ...
        MapMakerInternalMap.InternalEntry<E, MapMaker.Dummy, ?> entry = map.getEntry(sample);
        if (entry != null) {
