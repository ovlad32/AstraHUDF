...
/**
 * Implementation of {@link vendor.google.common.collect.Table} using linked hash tables. This guarantees predictable iteration
...
public class HashBasedTable<R, C, V> extends vendor.google.common.collect.StandardTable<R, C, V> {
  private static class Factory<C, V> implements Supplier<Map<C, V>>, Serializable {
    ...
    @Override
    public Map<C, V> get() {
      return vendor.google.common.collect.Maps.newLinkedHashMapWithExpectedSize(expectedSize);
    }
