...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V>
  ...
  public static <K, V> ImmutableSetMultimap<K, V> of() {
    return (ImmutableSetMultimap<K, V>) vendor.google.common.collect.EmptyImmutableSetMultimap.INSTANCE;
  }
  ...
  @vendor.google.common.annotations.GwtIncompatible // java serialization
