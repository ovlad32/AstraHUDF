...
/**
 * Basic implementation of the {@link vendor.google.common.collect.SetMultimap} interface. It's a wrapper around {@link
 * vendor.google.common.collect.AbstractMapBasedMultimap} that converts the returned collections into {@code Sets}. The {@link
 * #createCollection} method must return a {@code Set}.
 *
 * @author Jared Levy
 */
@GwtCompatible
abstract class AbstractSetMultimap<K, V> extends vendor.google.common.collect.AbstractMapBasedMultimap<K, V>
   ...
   * {@link Set}, instead of the {@link Collection} specified in the {@link vendor.google.common.collect.Multimap} interface.
   */
  @Override
