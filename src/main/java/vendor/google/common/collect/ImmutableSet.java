...
public abstract class ImmutableSet<E> extends ImmutableCollection<E> implements Set<E> {
  ...
  public static <E> ImmutableSet<E> of() {
    return (ImmutableSet<E>) vendor.google.common.collect.RegularImmutableSet.EMPTY;
  }
  ...
  public boolean equals(@Nullable Object object) {
    ...
    return vendor.google.common.collect.Sets.equalsImpl(this, object);
  }
  ...
  abstract static class Indexed<E> extends ImmutableSet<E> {
    ...
    @Override
    ImmutableList<E> createAsList() {
      return new vendor.google.common.collect.ImmutableAsList<E>() {
        @Override
    ...
    ImmutableSet<E> build() {
      switch (distinct) {
        ...
        default:
          ...
          return new vendor.google.common.collect.RegularImmutableSet<E>(elements, hashCode, hashTable, hashTable.length - 1);
      }
    }
  }
