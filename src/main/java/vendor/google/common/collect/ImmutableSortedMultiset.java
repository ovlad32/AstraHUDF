...
/**
 * A {@link vendor.google.common.collect.SortedMultiset} whose contents will never change, with many other important properties
...
public abstract class ImmutableSortedMultiset<E> extends vendor.google.common.collect.ImmutableSortedMultisetFauxverideShim<E>
  ...
  public static <T, E> Collector<T, ?, ImmutableSortedMultiset<E>> toImmutableSortedMultiset(
    ...
    return Collector.of(
        () -> vendor.google.common.collect.TreeMultiset.create(comparator),
        (multiset, t) ->
  ...
  public static <E> ImmutableSortedMultiset<E> of() {
    return (ImmutableSortedMultiset) vendor.google.common.collect.RegularImmutableSortedMultiset.NATURAL_EMPTY_MULTISET;
  }
  ...
  public static <E extends Comparable<? super E>> ImmutableSortedMultiset<E> of(E element) {
    ...
    return new vendor.google.common.collect.RegularImmutableSortedMultiset<E>(elementSet, cumulativeCounts, 0, 1);
  }
  ...
  public static <E extends Comparable<? super E>> ImmutableSortedMultiset<E> of(E e1, E e2) {
    return copyOf(vendor.google.common.collect.Ordering.natural(), Arrays.asList(e1, e2));
  }
  ...
  public static <E extends Comparable<? super E>> ImmutableSortedMultiset<E> of(E e1, E e2, E e3) {
    return copyOf(vendor.google.common.collect.Ordering.natural(), Arrays.asList(e1, e2, e3));
  }
  ...
  public static <E extends Comparable<? super E>> ImmutableSortedMultiset<E> of(
      E e1, E e2, E e3, E e4) {
    return copyOf(vendor.google.common.collect.Ordering.natural(), Arrays.asList(e1, e2, e3, e4));
  }
  ...
  public static <E extends Comparable<? super E>> ImmutableSortedMultiset<E> of(
    ...
    return copyOf(vendor.google.common.collect.Ordering.natural(), Arrays.asList(e1, e2, e3, e4, e5));
  }
  ...
  public static <E extends Comparable<? super E>> ImmutableSortedMultiset<E> of(
    ...
    return copyOf(vendor.google.common.collect.Ordering.natural(), all);
  }
  ...
  public static <E extends Comparable<? super E>> ImmutableSortedMultiset<E> copyOf(E[] elements) {
    return copyOf(vendor.google.common.collect.Ordering.natural(), Arrays.asList(elements));
  }
  ...
  public static <E> ImmutableSortedMultiset<E> copyOf(
    ...
    vendor.google.common.collect.TreeMultiset<E> sortedCopy = vendor.google.common.collect.TreeMultiset.create(checkNotNull(comparator));
   ...
   */
  public static <E> ImmutableSortedMultiset<E> copyOfSorted(vendor.google.common.collect.SortedMultiset<E> sortedMultiset) {
  ...
  private static <E> ImmutableSortedMultiset<E> copyOfSortedEntries(
      Comparator<? super E> comparator, Collection<Multiset.Entry<E>> entries) {
    if (entries.isEmpty()) {
    ...
    return new vendor.google.common.collect.RegularImmutableSortedMultiset<E>(
  ...
  static <E> ImmutableSortedMultiset<E> emptyMultiset(Comparator<? super E> comparator) {
    if (vendor.google.common.collect.Ordering.natural().equals(comparator)) {
      return (ImmutableSortedMultiset<E>) vendor.google.common.collect.RegularImmutableSortedMultiset.NATURAL_EMPTY_MULTISET;
    } else {
      return new vendor.google.common.collect.RegularImmutableSortedMultiset<E>(comparator);
    }
  }
  ...
  public ImmutableSortedMultiset<E> descendingMultiset() {
    ...
    if (result == null) {
      return descendingMultiset =
          this.isEmpty()
              ? emptyMultiset(vendor.google.common.collect.Ordering.from(comparator()).reverse())
  ...
  @Override
  public abstract ImmutableSortedMultiset<E> headMultiset(E upperBound, vendor.google.common.collect.BoundType boundType);
  ...
  public static <E extends Comparable<?>> Builder<E> reverseOrder() {
    return new Builder<E>(vendor.google.common.collect.Ordering.natural().reverse());
  }

  /**
   * Returns a builder that creates immutable sorted multisets whose elements are ordered by their
   * natural ordering. The sorted multisets use {@link vendor.google.common.collect.Ordering#natural()} as the comparator. This
  ...
  public static class Builder<E> extends ImmutableMultiset.Builder<E> {
    ...
    public ImmutableSortedMultiset<E> build() {
      return copyOfSorted((vendor.google.common.collect.SortedMultiset<E>) contents);
    }
  }
