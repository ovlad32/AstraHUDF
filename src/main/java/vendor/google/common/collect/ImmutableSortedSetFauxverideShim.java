...
/**
 * "Overrides" the {@link vendor.google.common.collect.ImmutableSet} static methods that lack {@link ImmutableSortedSet}
 ...
 */
@GwtIncompatible
abstract class ImmutableSortedSetFauxverideShim<E> extends vendor.google.common.collect.ImmutableSet<E> {
  /**
   * Not supported. Use {@link ImmutableSortedSet#toImmutableSortedSet} instead. This method exists
   * only to hide {@link vendor.google.common.collect.ImmutableSet#toImmutableSet} from consumers of {@code ImmutableSortedSet}.
   *
   ...
   */
  @Deprecated
  public static <E> Collector<E, ?, vendor.google.common.collect.ImmutableSet<E>> toImmutableSet() {
    throw new UnsupportedOperationException();
  }

  /**
   * Not supported. Use {@link ImmutableSortedSet#naturalOrder}, which offers better type-safety,
   * instead. This method exists only to hide {@link vendor.google.common.collect.ImmutableSet#builder} from consumers of {@code
   * ImmutableSortedSet}.
   *
   * @throws UnsupportedOperationException always
