...
public final class HashMultiset<E> extends AbstractMapBasedMultiset<E> {
  ...
  private HashMultiset(int distinctElements) {
    super(vendor.google.common.collect.Maps.<E, Count>newHashMapWithExpectedSize(distinctElements));
  }
  ...
  private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
    ...
    int distinctElements = vendor.google.common.collect.Serialization.readCount(stream);
    setBackingMap(Maps.<E, Count>newHashMap());
    vendor.google.common.collect.Serialization.populateMultiset(this, stream, distinctElements);
  }
