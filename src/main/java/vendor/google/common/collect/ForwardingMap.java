...
public abstract class ForwardingMap<K, V> extends ForwardingObject implements Map<K, V> {
  ...
  protected void standardPutAll(Map<? extends K, ? extends V> map) {
    vendor.google.common.collect.Maps.putAllImpl(this, map);
  }
   ...
   */
  @vendor.google.common.annotations.Beta
  protected class StandardKeySet extends vendor.google.common.collect.Maps.KeySet<K, V> {
    /** Constructor for use by subclasses. */
  ...
  protected boolean standardContainsKey(@Nullable Object key) {
    return vendor.google.common.collect.Maps.containsKeyImpl(this, key);
  }
   ...
   */
  @vendor.google.common.annotations.Beta
  protected class StandardValues extends vendor.google.common.collect.Maps.Values<K, V> {
    /** Constructor for use by subclasses. */
  ...
  protected boolean standardContainsValue(@Nullable Object value) {
    return vendor.google.common.collect.Maps.containsValueImpl(this, value);
  }
   ...
   */
  @Beta
  protected abstract class StandardEntrySet extends vendor.google.common.collect.Maps.EntrySet<K, V> {
    /** Constructor for use by subclasses. */
