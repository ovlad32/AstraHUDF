...
final class SortedLists {
   ...
   * KeyAbsentBehavior)} using {@link vendor.google.common.collect.Ordering#natural}.
   */
  public static <E extends Comparable> int binarySearch(
    ...
    checkNotNull(e);
    return binarySearch(list, e, vendor.google.common.collect.Ordering.natural(), presentBehavior, absentBehavior);
  }
   ...
   * KeyAbsentBehavior)} using {@link vendor.google.common.collect.Lists#transform(List, Function) Lists.transform(list,
   * keyFunction)}.
   */
  public static <E, K> int binarySearch(
      ...
      KeyAbsentBehavior absentBehavior) {
    return binarySearch(
        vendor.google.common.collect.Lists.transform(list, keyFunction), key, keyComparator, presentBehavior, absentBehavior);
  }
