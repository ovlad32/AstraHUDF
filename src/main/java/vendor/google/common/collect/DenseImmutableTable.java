...
final class DenseImmutableTable<R, C, V> extends vendor.google.common.collect.RegularImmutableTable<R, C, V> {
  ...
  DenseImmutableTable(
      ...
      vendor.google.common.collect.ImmutableSet<C> columnSpace) {
    @SuppressWarnings("unchecked")
    V[][] array = (V[][]) new Object[rowSpace.size()][columnSpace.size()];
    this.values = array;
    this.rowKeyToIndex = vendor.google.common.collect.Maps.indexMap(rowSpace);
    this.columnKeyToIndex = vendor.google.common.collect.Maps.indexMap(columnSpace);
