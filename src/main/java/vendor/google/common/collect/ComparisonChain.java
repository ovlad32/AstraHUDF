  ...
  private static final ComparisonChain ACTIVE =
      new ComparisonChain() {
        ...
        public ComparisonChain compare(int left, int right) {
          return classify(vendor.google.common.primitives.Ints.compare(left, right));
        }

        @Override
        public ComparisonChain compare(long left, long right) {
          return classify(vendor.google.common.primitives.Longs.compare(left, right));
        }
        ...
        public ComparisonChain compareTrueFirst(boolean left, boolean right) {
          return classify(vendor.google.common.primitives.Booleans.compare(right, left)); // reversed
        }
