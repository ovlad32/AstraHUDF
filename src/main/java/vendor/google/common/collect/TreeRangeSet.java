...
public class TreeRangeSet<C extends Comparable<?>> extends vendor.google.common.collect.AbstractRangeSet<C>
  ...
  static final class RangesByUpperBound<C extends Comparable<?>>
    ...
    public NavigableMap<Cut<C>, Range<C>> subMap(
      ...
      return subMap(
          Range.range(
              fromKey, vendor.google.common.collect.BoundType.forBoolean(fromInclusive),
              toKey, vendor.google.common.collect.BoundType.forBoolean(toInclusive)));
    }

    @Override
    public NavigableMap<Cut<C>, Range<C>> headMap(Cut<C> toKey, boolean inclusive) {
      return subMap(Range.upTo(toKey, vendor.google.common.collect.BoundType.forBoolean(inclusive)));
    }

    @Override
    public NavigableMap<Cut<C>, Range<C>> tailMap(Cut<C> fromKey, boolean inclusive) {
      return subMap(Range.downTo(fromKey, vendor.google.common.collect.BoundType.forBoolean(inclusive)));
    }
    ...
    Iterator<Entry<Cut<C>, Range<C>>> entryIterator() {
      ...
      return new vendor.google.common.collect.AbstractIterator<Entry<Cut<C>, Range<C>>>() {
        @Override
  ...
  private static final class ComplementRangesByLowerBound<C extends Comparable<?>>
        ...
        positiveRanges =
            positiveRangesByUpperBound
                .tailMap(
                    ...
                    complementLowerBoundWindow.lowerBoundType() == vendor.google.common.collect.BoundType.CLOSED)
                .values();
      } else {
    ...
    Iterator<Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
      ...
      boolean inclusive =
          complementLowerBoundWindow.hasUpperBound()
              && complementLowerBoundWindow.upperBoundType() == vendor.google.common.collect.BoundType.CLOSED;
      final PeekingIterator<Range<C>> positiveItr =
  ...
  private static final class SubRangeSetRangesByLowerBound<C extends Comparable<?>>
    ...
    public NavigableMap<Cut<C>, Range<C>> subMap(
      ...
      return subMap(
          Range.range(
              fromKey,
              vendor.google.common.collect.BoundType.forBoolean(fromInclusive),
              toKey,
              vendor.google.common.collect.BoundType.forBoolean(toInclusive)));
    }
        ...
        completeRangeItr =
            rangesByLowerBound
                .tailMap(
                    ...
                    lowerBoundWindow.lowerBoundType() == vendor.google.common.collect.BoundType.CLOSED)
                .values()
                .iterator();
      }
