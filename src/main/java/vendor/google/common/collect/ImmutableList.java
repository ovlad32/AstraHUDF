...
import static vendor.google.common.collect.RegularImmutableList.EMPTY;
...
public abstract class ImmutableList<E> extends ImmutableCollection<E>
  ...
  public static <E> ImmutableList<E> of(E element) {
    return new vendor.google.common.collect.SingletonImmutableList<E>(element);
  }
  ...
  public static <E extends Comparable<? super E>> ImmutableList<E> sortedCopyOf(
    ...
    Comparable<?>[] array = vendor.google.common.collect.Iterables.toArray(elements, new Comparable<?>[0]);
  ...
  static <E> ImmutableList<E> asImmutableList(Object[] elements, int length) {
    switch (length) {
      ...
      default:
        ...
        return new vendor.google.common.collect.RegularImmutableList<E>(elements);
    }
  }
  ...
  @Override
  public vendor.google.common.collect.UnmodifiableListIterator<E> listIterator() {
    return listIterator(0);
  }

  @Override
  public UnmodifiableListIterator<E> listIterator(int index) {
    return new vendor.google.common.collect.AbstractIndexedListIterator<E>(size(), index) {
      @Override
