 ...
 * with {@link Collection} itself). Prefer subtypes such as {@link vendor.google.common.collect.ImmutableSet} or {@link
 * vendor.google.common.collect.ImmutableList}, which have well-defined {@link #equals} semantics, thus avoiding a common source
 ...
 * {@link vendor.google.common.collect.ImmutableList}) instead of the general collection interface type (such as {@link List}).
 * This communicates to your callers all of the semantic guarantees listed above, which is almost
 * always very useful information.
 *
 * <p>On the other hand, a <i>parameter</i> type of {@link vendor.google.common.collect.ImmutableList} is generally a nuisance to
 ...
 *       vendor.google.common.collect.ImmutableList#subList} may retain a reference to the entire data set, preventing it from
...
public abstract class ImmutableCollection<E> extends AbstractCollection<E> implements Serializable {
  ...
  public final <T> T[] toArray(T[] other) {
    ...
    if (other.length < size) {
      ...
      if (internal != null) {
        return vendor.google.common.collect.Platform.copy(internal, internalArrayStart(), internalArrayEnd(), other);
      }
   ...
   * @since 2.0
   */
  public vendor.google.common.collect.ImmutableList<E> asList() {
    switch (size()) {
      case 0:
        return vendor.google.common.collect.ImmutableList.of();
      case 1:
        return vendor.google.common.collect.ImmutableList.of(iterator().next());
      default:
        return new vendor.google.common.collect.RegularImmutableAsList<E>(this, toArray());
    }
  }
