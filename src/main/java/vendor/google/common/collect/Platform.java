...
final class Platform {
  ...
  static <E> Set<E> newHashSetWithExpectedSize(int expectedSize) {
    return vendor.google.common.collect.Sets.newHashSetWithExpectedSize(expectedSize);
  }
  ...
  static <E> Set<E> newLinkedHashSetWithExpectedSize(int expectedSize) {
    return vendor.google.common.collect.Sets.newLinkedHashSetWithExpectedSize(expectedSize);
  }
