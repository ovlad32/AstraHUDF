 ...
 * already in the multimap has no effect. See the {@link vendor.google.common.collect.Multimap} documentation for information
 ...
 */
@GwtCompatible
public interface SetMultimap<K, V> extends vendor.google.common.collect.Multimap<K, V> {
  /**
   * {@inheritDoc}
   *
   * <p>Because a {@code SetMultimap} has unique values for a given key, this method returns a
   * {@link Set}, instead of the {@link java.util.Collection} specified in the {@link vendor.google.common.collect.Multimap}
   * interface.
   */
  @Override
