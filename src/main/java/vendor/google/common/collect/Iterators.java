 ...
 * {@link vendor.google.common.collect.Iterables} class.
 *
...
public final class Iterators {
   ...
   *
   * <p>The {@link Iterable} equivalent of this method is {@link vendor.google.common.collect.ImmutableSet#of()}.
   */
  ...
  static <T> vendor.google.common.collect.UnmodifiableListIterator<T> emptyListIterator() {
    return (vendor.google.common.collect.UnmodifiableListIterator<T>) ArrayItr.EMPTY;
  }
   ...
   */
  @vendor.google.common.annotations.GwtIncompatible // Array.newInstance(Class, int)
  public static <T> T[] toArray(Iterator<? extends T> iterator, Class<T> type) {
    List<T> list = Lists.newArrayList(iterator);
    return vendor.google.common.collect.Iterables.toArray(list, type);
  }
  ...
  public static <F, T> Iterator<T> transform(
    ...
    return new vendor.google.common.collect.TransformedIterator<F, T>(fromIterator) {
      @Override
      T transform(F from) {
   ...
   * The {@link vendor.google.common.collect.Iterables} analog to this method is {@link vendor.google.common.collect.Iterables#getFirst}.
   *
   ...
   */
  static <T> vendor.google.common.collect.UnmodifiableListIterator<T> forArray(
  ...
  private static final class ArrayItr<T> extends vendor.google.common.collect.AbstractIndexedListIterator<T> {
  ...
  private static class PeekingImpl<E> implements vendor.google.common.collect.PeekingIterator<E> {
   ...
   * iterator's own {@link vendor.google.common.collect.PeekingIterator#remove()} method) will leave the iterator in an undefined
   * state.
   *
   * <p>The returned iterator does not support removal after peeking, as explained by {@link
   * vendor.google.common.collect.PeekingIterator#remove()}.
   *
   ...
   *
   * @param iterator the backing iterator. The {@link vendor.google.common.collect.PeekingIterator} assumes ownership of this
   ...
   *     vendor.google.common.collect.PeekingIterator#peek()} method, this iterator behaves exactly the same as {@code iterator}.
   */
  public static <T> vendor.google.common.collect.PeekingIterator<T> peekingIterator(Iterator<? extends T> iterator) {
   ...
   */
  @Deprecated
  public static <T> vendor.google.common.collect.PeekingIterator<T> peekingIterator(vendor.google.common.collect.PeekingIterator<T> iterator) {
    return checkNotNull(iterator);
  }
  ...
  private static class MergingIterator<T> extends UnmodifiableIterator<T> {
    final Queue<vendor.google.common.collect.PeekingIterator<T>> queue;
    ...
    public MergingIterator(
      ...
      Comparator<vendor.google.common.collect.PeekingIterator<T>> heapComparator =
          new Comparator<vendor.google.common.collect.PeekingIterator<T>>() {
            @Override
            public int compare(vendor.google.common.collect.PeekingIterator<T> o1, vendor.google.common.collect.PeekingIterator<T> o2) {
