 ...
 * ordering of values for a given key. See the {@link vendor.google.common.collect.Multimap} documentation for information common
 * to all multimaps.
 *
 ...
 */
@GwtCompatible
public interface ListMultimap<K, V> extends vendor.google.common.collect.Multimap<K, V> {
  /**
   * {@inheritDoc}
   *
   ...
   * the {@link vendor.google.common.collect.Multimap} interface.
   */
  @Override
