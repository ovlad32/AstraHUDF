 ...
 *       size. In many cases {@link vendor.google.common.collect.Ordering#leastOf} may work for your use case with significantly
...
public final class MinMaxPriorityQueue<E> extends AbstractQueue<E> {
  ...
  public static <E extends Comparable<E>> MinMaxPriorityQueue<E> create() {
    return new Builder<Comparable>(vendor.google.common.collect.Ordering.natural()).create();
  }
  ...
  public static <E extends Comparable<E>> MinMaxPriorityQueue<E> create(
    ...
    return new Builder<E>(vendor.google.common.collect.Ordering.<E>natural()).create(initialContents);
  }
  ...
  public static Builder<Comparable> expectedSize(int expectedSize) {
    return new Builder<Comparable>(vendor.google.common.collect.Ordering.natural()).expectedSize(expectedSize);
  }
  ...
  public static Builder<Comparable> maximumSize(int maximumSize) {
    return new Builder<Comparable>(vendor.google.common.collect.Ordering.natural()).maximumSize(maximumSize);
  }
  ...
  public static final class Builder<B> {
    ...
    private <T extends B> vendor.google.common.collect.Ordering<T> ordering() {
      return vendor.google.common.collect.Ordering.from((Comparator<T>) comparator);
    }
  }
  ...
  private MinMaxPriorityQueue(Builder<? super E> builder, int queueSize) {
    vendor.google.common.collect.Ordering<E> ordering = builder.ordering();
  ...
  @WeakOuter
  private class Heap {
    final vendor.google.common.collect.Ordering<E> ordering;
    @MonotonicNonNull @Weak Heap otherHeap;

    Heap(vendor.google.common.collect.Ordering<E> ordering) {
