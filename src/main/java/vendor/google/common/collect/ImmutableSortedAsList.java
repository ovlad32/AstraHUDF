...
final class ImmutableSortedAsList<E> extends vendor.google.common.collect.RegularImmutableAsList<E>
    implements vendor.google.common.collect.SortedIterable<E> {
  ImmutableSortedAsList(vendor.google.common.collect.ImmutableSortedSet<E> backingSet, vendor.google.common.collect.ImmutableList<E> backingList) {
    super(backingSet, backingList);
  }

  @Override
  vendor.google.common.collect.ImmutableSortedSet<E> delegateCollection() {
  ...
  @vendor.google.common.annotations.GwtIncompatible // ImmutableSortedSet.indexOf
   ...
   */
  @Override
  vendor.google.common.collect.ImmutableList<E> subListUnchecked(int fromIndex, int toIndex) {
    vendor.google.common.collect.ImmutableList<E> parentSubList = super.subListUnchecked(fromIndex, toIndex);
    return new vendor.google.common.collect.RegularImmutableSortedSet<E>(parentSubList, comparator()).asList();
  }
