...
import static vendor.google.common.collect.ObjectArrays.checkElementsNotNull;
...
public abstract class ImmutableSortedSet<E> extends vendor.google.common.collect.ImmutableSortedSetFauxverideShim<E>
    implements NavigableSet<E>, vendor.google.common.collect.SortedIterable<E> {
  static final int SPLITERATOR_CHARACTERISTICS =
      vendor.google.common.collect.ImmutableSet.SPLITERATOR_CHARACTERISTICS | Spliterator.SORTED;
  ...
  static <E> vendor.google.common.collect.RegularImmutableSortedSet<E> emptySet(Comparator<? super E> comparator) {
    if (vendor.google.common.collect.Ordering.natural().equals(comparator)) {
      return (vendor.google.common.collect.RegularImmutableSortedSet<E>) vendor.google.common.collect.RegularImmutableSortedSet.NATURAL_EMPTY_SET;
    } else {
      return new vendor.google.common.collect.RegularImmutableSortedSet<E>(ImmutableList.<E>of(), comparator);
    }
  }

  /** Returns the empty immutable sorted set. */
  public static <E> ImmutableSortedSet<E> of() {
    return (ImmutableSortedSet<E>) vendor.google.common.collect.RegularImmutableSortedSet.NATURAL_EMPTY_SET;
  }

  /** Returns an immutable sorted set containing a single element. */
  public static <E extends Comparable<? super E>> ImmutableSortedSet<E> of(E element) {
    return new vendor.google.common.collect.RegularImmutableSortedSet<E>(ImmutableList.of(element), vendor.google.common.collect.Ordering.natural());
  }
  ...
  public static <E extends Comparable<? super E>> ImmutableSortedSet<E> of(E e1, E e2) {
    return construct(vendor.google.common.collect.Ordering.natural(), 2, e1, e2);
  }
  ...
  public static <E extends Comparable<? super E>> ImmutableSortedSet<E> of(E e1, E e2, E e3) {
    return construct(vendor.google.common.collect.Ordering.natural(), 3, e1, e2, e3);
  }
  ...
  public static <E extends Comparable<? super E>> ImmutableSortedSet<E> of(E e1, E e2, E e3, E e4) {
    return construct(vendor.google.common.collect.Ordering.natural(), 4, e1, e2, e3, e4);
  }
  ...
  public static <E extends Comparable<? super E>> ImmutableSortedSet<E> of(
    ...
    return construct(vendor.google.common.collect.Ordering.natural(), 5, e1, e2, e3, e4, e5);
  }
  ...
  public static <E extends Comparable<? super E>> ImmutableSortedSet<E> of(
    ...
    return construct(vendor.google.common.collect.Ordering.natural(), contents.length, (E[]) contents);
  }
  ...
  public static <E extends Comparable<? super E>> ImmutableSortedSet<E> copyOf(E[] elements) {
    return construct(vendor.google.common.collect.Ordering.natural(), elements.length, elements.clone());
  }
  ...
  public static <E> ImmutableSortedSet<E> copyOf(Iterable<? extends E> elements) {
    ...
    @SuppressWarnings("unchecked")
    vendor.google.common.collect.Ordering<E> naturalOrder = (vendor.google.common.collect.Ordering<E>) vendor.google.common.collect.Ordering.<Comparable>natural();
  ...
  public static <E> ImmutableSortedSet<E> copyOf(
    ...
    boolean hasSameComparator = vendor.google.common.collect.SortedIterables.hasSameComparator(comparator, elements);
    ...
    E[] array = (E[]) vendor.google.common.collect.Iterables.toArray(elements);
  ...
  public static <E> ImmutableSortedSet<E> copyOfSorted(SortedSet<E> sortedSet) {
    Comparator<? super E> comparator = vendor.google.common.collect.SortedIterables.comparator(sortedSet);
    ImmutableList<E> list = ImmutableList.copyOf(sortedSet);
    if (list.isEmpty()) {
      return emptySet(comparator);
    } else {
      return new vendor.google.common.collect.RegularImmutableSortedSet<E>(list, comparator);
    }
  }
  ...
  static <E> ImmutableSortedSet<E> construct(
    ...
    return new vendor.google.common.collect.RegularImmutableSortedSet<E>(
   ...
   * natural ordering. The sorted sets use {@link vendor.google.common.collect.Ordering#natural()} as the comparator. This method
   * provides more type-safety than {@link #builder}, as it can be called only for classes that
   * implement {@link Comparable}.
   */
  public static <E extends Comparable<?>> Builder<E> naturalOrder() {
    return new Builder<E>(vendor.google.common.collect.Ordering.natural());
  }
   ...
   * @since 2.0
   */
  public static final class Builder<E> extends vendor.google.common.collect.ImmutableSet.Builder<E> {
  ...
  @Override
  public E lower(E e) {
    return vendor.google.common.collect.Iterators.getNext(headSet(e, false).descendingIterator(), null);
  }
  ...
  public E ceiling(E e) {
    return vendor.google.common.collect.Iterables.getFirst(tailSet(e, true), null);
  }
