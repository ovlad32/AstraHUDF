...
import static vendor.google.common.collect.BoundType.CLOSED;
import static vendor.google.common.collect.BoundType.OPEN;
...
final class GeneralRange<T> implements Serializable {
  ...
  static <T extends Comparable> GeneralRange<T> from(Range<T> range) {
    ...
    vendor.google.common.collect.BoundType lowerBoundType = range.hasLowerBound() ? range.lowerBoundType() : OPEN;

    @Nullable T upperEndpoint = range.hasUpperBound() ? range.upperEndpoint() : null;
    vendor.google.common.collect.BoundType upperBoundType = range.hasUpperBound() ? range.upperBoundType() : OPEN;
    return new GeneralRange<T>(
        vendor.google.common.collect.Ordering.natural(),
        range.hasLowerBound(),
        lowerEndpoint,
        lowerBoundType,
        range.hasUpperBound(),
  ...
  static <T> GeneralRange<T> downTo(
      Comparator<? super T> comparator, @Nullable T endpoint, vendor.google.common.collect.BoundType boundType) {
  ...
  static <T> GeneralRange<T> range(
      ...
      @Nullable T lower,
      vendor.google.common.collect.BoundType lowerType,
      @Nullable T upper,
      vendor.google.common.collect.BoundType upperType) {
  ...
  private final vendor.google.common.collect.BoundType lowerBoundType;
  private final boolean hasUpperBound;
  private final @Nullable T upperEndpoint;
  private final vendor.google.common.collect.BoundType upperBoundType;

  private GeneralRange(
      Comparator<? super T> comparator,
      boolean hasLowerBound,
      @Nullable T lowerEndpoint,
      vendor.google.common.collect.BoundType lowerBoundType,
      boolean hasUpperBound,
      @Nullable T upperEndpoint,
      vendor.google.common.collect.BoundType upperBoundType) {
  ...
  GeneralRange<T> intersect(GeneralRange<T> other) {
    ...
    vendor.google.common.collect.BoundType lowType = getLowerBoundType();
    if (!hasLowerBound()) {
    ...
    vendor.google.common.collect.BoundType upType = getUpperBoundType();
    if (!hasUpperBound()) {
  ...
  vendor.google.common.collect.BoundType getLowerBoundType() {
