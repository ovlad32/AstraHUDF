...
import static vendor.google.common.collect.CollectPreconditions.checkEntryNotNull;
...
import vendor.google.common.annotations.VisibleForTesting;
...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
  ...
  public static <K, V> ImmutableMap<K, V> of() {
    return (ImmutableMap<K, V>) vendor.google.common.collect.RegularImmutableMap.EMPTY;
  }
  ...
  public static <K, V> ImmutableMap<K, V> of(K k1, V v1, K k2, V v2) {
    return vendor.google.common.collect.RegularImmutableMap.fromEntries(entryOf(k1, v1), entryOf(k2, v2));
  }
  ...
  public static <K, V> ImmutableMap<K, V> of(K k1, V v1, K k2, V v2, K k3, V v3) {
    return vendor.google.common.collect.RegularImmutableMap.fromEntries(entryOf(k1, v1), entryOf(k2, v2), entryOf(k3, v3));
  }
  ...
  public static <K, V> ImmutableMap<K, V> of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4) {
    return vendor.google.common.collect.RegularImmutableMap.fromEntries(
  ...
  public static class Builder<K, V> {
    ...
    public ImmutableMap<K, V> build() {
      ...
      if (valueComparator != null) {
        ...
        Arrays.sort(
            entries, 0, size, Ordering.from(valueComparator).onResultOf(vendor.google.common.collect.Maps.<V>valueFunction()));
      }
      switch (size) {
        case 0:
          return of();
        ...
        default:
          entriesUsed = true;
          return vendor.google.common.collect.RegularImmutableMap.fromEntryArray(size, entries);
      }
    }
  ...
  public static <K, V> ImmutableMap<K, V> copyOf(
    ...
    switch (entryArray.length) {
      ...
      default:
         ...
         */
        return vendor.google.common.collect.RegularImmutableMap.fromEntries(entryArray);
    }
  }
  ...
  abstract static class IteratorBasedImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    @Override
    vendor.google.common.collect.ImmutableSet<K> createKeySet() {
      return new vendor.google.common.collect.ImmutableMapKeySet<>(this);
    }

    @Override
    vendor.google.common.collect.ImmutableSet<Entry<K, V>> createEntrySet() {
    ...
    ImmutableCollection<V> createValues() {
      return new vendor.google.common.collect.ImmutableMapValues<>(this);
    }
  }
  ...
  @LazyInit @RetainedWith private transient vendor.google.common.collect.ImmutableSet<Entry<K, V>> entrySet;
   ...
   */
  @Override
  public vendor.google.common.collect.ImmutableSet<Entry<K, V>> entrySet() {
    vendor.google.common.collect.ImmutableSet<Entry<K, V>> result = entrySet;
    return (result == null) ? entrySet = createEntrySet() : result;
  }

  abstract vendor.google.common.collect.ImmutableSet<Entry<K, V>> createEntrySet();

  @LazyInit @RetainedWith private transient vendor.google.common.collect.ImmutableSet<K> keySet;
   ...
   */
  @Override
  public vendor.google.common.collect.ImmutableSet<K> keySet() {
    vendor.google.common.collect.ImmutableSet<K> result = keySet;
   ...
   * overrides it.
   */
  abstract vendor.google.common.collect.ImmutableSet<K> createKeySet();
  ...
  @LazyInit private transient vendor.google.common.collect.ImmutableSetMultimap<K, V> multimapView;
   ...
   * @since 14.0
   */
  public vendor.google.common.collect.ImmutableSetMultimap<K, V> asMultimap() {
    if (isEmpty()) {
      return vendor.google.common.collect.ImmutableSetMultimap.of();
    }
    vendor.google.common.collect.ImmutableSetMultimap<K, V> result = multimapView;
    return (result == null)
        ? (multimapView =
  ...
  private final class MapViewOfValuesAsSingletonSets
      extends IteratorBasedImmutableMap<K, vendor.google.common.collect.ImmutableSet<V>> {
    ...
    @Override
    public vendor.google.common.collect.ImmutableSet<V> get(@Nullable Object key) {
      V outerValue = ImmutableMap.this.get(key);
      return (outerValue == null) ? null : vendor.google.common.collect.ImmutableSet.of(outerValue);
    }
    ...
    @Override
    UnmodifiableIterator<Entry<K, vendor.google.common.collect.ImmutableSet<V>>> entryIterator() {
      final Iterator<Entry<K, V>> backingIterator = ImmutableMap.this.entrySet().iterator();
      return new UnmodifiableIterator<Entry<K, vendor.google.common.collect.ImmutableSet<V>>>() {
        @Override
        public boolean hasNext() {
        ...
        @Override
        public Entry<K, vendor.google.common.collect.ImmutableSet<V>> next() {
          final Entry<K, V> backingEntry = backingIterator.next();
          return new vendor.google.common.collect.AbstractMapEntry<K, vendor.google.common.collect.ImmutableSet<V>>() {
            @Override
            public K getKey() {
            ...
            @Override
            public vendor.google.common.collect.ImmutableSet<V> getValue() {
  ...
  public boolean equals(@Nullable Object object) {
    return vendor.google.common.collect.Maps.equalsImpl(this, object);
  }
