...
import vendor.google.common.collect.Tables.AbstractCell;
...
/**
 * A {@link vendor.google.common.collect.Table} whose contents will never change, with many other important properties detailed
...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V>
  ...
  private static final class CollectorState<R, C, V> {
    ...
    final vendor.google.common.collect.Table<R, C, MutableCell<R, C, V>> table = HashBasedTable.create();
  ...
  public static <R, C, V> ImmutableTable<R, C, V> of(R rowKey, C columnKey, V value) {
    return new vendor.google.common.collect.SingletonImmutableTable<>(rowKey, columnKey, value);
  }

  /**
   * Returns an immutable copy of the provided table.
   *
   * <p>The {@link vendor.google.common.collect.Table#cellSet()} iteration order of the provided table determines the iteration
  ...
  static <R, C, V> Cell<R, C, V> cellOf(R rowKey, C columnKey, V value) {
    return vendor.google.common.collect.Tables.immutableCell(
   ...
   * vendor.google.common.collect.Table#cellSet()} iteration order. However, if {@link #orderRowsBy} or {@link #orderColumnsBy}
  ...
  public static final class Builder<R, C, V> {
     ...
     */
    @CanIgnoreReturnValue
    public Builder<R, C, V> putAll(vendor.google.common.collect.Table<? extends R, ? extends C, ? extends V> table) {
    ...
    public ImmutableTable<R, C, V> build() {
      ...
      switch (size) {
        case 0:
          return of();
        case 1:
          return new vendor.google.common.collect.SingletonImmutableTable<>(Iterables.getOnlyElement(cells));
        default:
          return vendor.google.common.collect.RegularImmutableTable.forCells(cells, rowComparator, columnComparator);
      }
    }
  }
  ...
  @Override
  public vendor.google.common.collect.ImmutableSet<Cell<R, C, V>> cellSet() {
    return (vendor.google.common.collect.ImmutableSet<Cell<R, C, V>>) super.cellSet();
  }

  @Override
  abstract vendor.google.common.collect.ImmutableSet<Cell<R, C, V>> createCellSet();
  ...
  @Override
  public vendor.google.common.collect.ImmutableSet<R> rowKeySet() {
  ...
  static final class SerializedForm implements Serializable {
    ...
    Object readResolve() {
      ...
      return vendor.google.common.collect.RegularImmutableTable.forOrderedComponents(
          cellListBuilder.build(), vendor.google.common.collect.ImmutableSet.copyOf(rowKeys), ImmutableSet.copyOf(columnKeys));
    }
