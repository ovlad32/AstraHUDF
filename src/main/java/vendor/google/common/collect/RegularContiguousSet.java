...
final class RegularContiguousSet<C extends Comparable> extends ContiguousSet<C> {
  ...
  RegularContiguousSet(Range<C> range, vendor.google.common.collect.DiscreteDomain<C> domain) {
    super(domain);
    this.range = range;
  }
  ...
  ContiguousSet<C> headSetImpl(C toElement, boolean inclusive) {
    return intersectionInCurrentDomain(Range.upTo(toElement, vendor.google.common.collect.BoundType.forBoolean(inclusive)));
  }
  ...
  ContiguousSet<C> subSetImpl(
    ...
    return intersectionInCurrentDomain(
        Range.range(
            fromElement, vendor.google.common.collect.BoundType.forBoolean(fromInclusive),
            toElement, vendor.google.common.collect.BoundType.forBoolean(toInclusive)));
  }

  @Override
  ContiguousSet<C> tailSetImpl(C fromElement, boolean inclusive) {
    return intersectionInCurrentDomain(Range.downTo(fromElement, vendor.google.common.collect.BoundType.forBoolean(inclusive)));
  }
  ...
  ImmutableList<C> createAsList() {
    if (domain.supportsFastOffset) {
      return new vendor.google.common.collect.ImmutableAsList<C>() {
        @Override
  ...
  public ContiguousSet<C> intersection(ContiguousSet<C> other) {
    ...
    if (other.isEmpty()) {
      ...
      C lowerEndpoint = vendor.google.common.collect.Ordering.natural().max(this.first(), other.first());
