 ...
 * the {@code Collection} specified by the {@link vendor.google.common.collect.ListMultimap} interface.
 *
 ...
 * with a call to {@link vendor.google.common.collect.Multimaps#synchronizedListMultimap}.
 *
...
public class LinkedListMultimap<K, V> extends vendor.google.common.collect.AbstractMultimap<K, V>
    implements vendor.google.common.collect.ListMultimap<K, V>, Serializable {
  /*
  ...
  private static final class Node<K, V> extends vendor.google.common.collect.AbstractMapEntry<K, V> {
   ...
   * Multimap}. The new multimap has the same {@link vendor.google.common.collect.Multimap#entries()} iteration order as the
   * input multimap.
   *
  ...
  private LinkedListMultimap(int expectedKeys) {
    keyToKeyList = vendor.google.common.collect.Platform.newHashMapWithExpectedSize(expectedKeys);
  }
  ...
  private class DistinctKeyIterator implements Iterator<K> {
    final Set<K> seenKeys = vendor.google.common.collect.Sets.<K>newHashSetWithExpectedSize(keySet().size());
    Node<K, V> next = head;
    @Nullable Node<K, V> current;
    int expectedModCount = modCount;
  ...
  Multiset<K> createKeys() {
    return new vendor.google.common.collect.Multimaps.Keys<K, V>(this);
  }
   ...
   * the {@link vendor.google.common.collect.ListMultimap} interface.
   */
  @Override
  ...
  List<V> createValues() {
    ...
    class ValuesImpl extends AbstractSequentialList<V> {
      ...
      public ListIterator<V> listIterator(int index) {
        ...
        return new vendor.google.common.collect.TransformedListIterator<Entry<K, V>, V>(nodeItr) {
          @Override
