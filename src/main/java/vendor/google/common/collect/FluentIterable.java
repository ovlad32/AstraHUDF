...
import vendor.google.common.base.Joiner;
 ...
 * vendor.google.common.collect.Iterables} class.
 *
 * <p><a name="streams"></a>
 *
...
public abstract class FluentIterable<E> implements Iterable<E> {
  ...
  public static <T> FluentIterable<T> concat(
    ...
    return new FluentIterable<T>() {
      ...
      public Iterator<T> iterator() {
        return vendor.google.common.collect.Iterators.concat(vendor.google.common.collect.Iterators.transform(inputs.iterator(), vendor.google.common.collect.Iterables.<T>toIterator()));
      }
    };
  }
    ...
    return new FluentIterable<T>() {
      ...
      public Iterator<T> iterator() {
        return Iterators.concat(
            ...
            new vendor.google.common.collect.AbstractIndexedListIterator<Iterator<? extends T>>(inputs.length) {
              @Override
  ...
  public String toString() {
    return vendor.google.common.collect.Iterables.toString(getDelegate());
  }
  ...
  public final int size() {
    return vendor.google.common.collect.Iterables.size(getDelegate());
  }
  ...
  public final boolean contains(@Nullable Object target) {
    return vendor.google.common.collect.Iterables.contains(getDelegate(), target);
  }
  ...
  public final FluentIterable<E> cycle() {
    return from(vendor.google.common.collect.Iterables.cycle(getDelegate()));
  }
  ...
  public final FluentIterable<E> filter(Predicate<? super E> predicate) {
    return from(vendor.google.common.collect.Iterables.filter(getDelegate(), predicate));
  }
   ...
   * </pre>
   */
  @vendor.google.common.annotations.GwtIncompatible // Class.isInstance
  public final <T> FluentIterable<T> filter(Class<T> type) {
    return from(vendor.google.common.collect.Iterables.filter(getDelegate(), type));
  }
  ...
  public final boolean anyMatch(Predicate<? super E> predicate) {
    return vendor.google.common.collect.Iterables.any(getDelegate(), predicate);
  }
  ...
  public final boolean allMatch(Predicate<? super E> predicate) {
    return vendor.google.common.collect.Iterables.all(getDelegate(), predicate);
  }
  ...
  public final Optional<E> firstMatch(Predicate<? super E> predicate) {
    return vendor.google.common.collect.Iterables.tryFind(getDelegate(), predicate);
  }
  ...
  public final <T> FluentIterable<T> transform(Function<? super E, T> function) {
    return from(vendor.google.common.collect.Iterables.transform(getDelegate(), function));
  }
   ...
   *     iterator().next()} or {@link vendor.google.common.collect.Iterables#getFirst} instead.
   */
   ...
   *     vendor.google.common.collect.Iterables#getLast} instead.
   */
  ...
  public final FluentIterable<E> skip(int numberToSkip) {
    return from(vendor.google.common.collect.Iterables.skip(getDelegate(), numberToSkip));
  }
  ...
  public final FluentIterable<E> limit(int maxSize) {
    return from(vendor.google.common.collect.Iterables.limit(getDelegate(), maxSize));
  }
   ...
   * duplicates removed.
   *
   * <p><b>{@code Stream} equivalent:</b> pass {@link vendor.google.common.collect.ImmutableSet#toImmutableSet} to {@code
   * stream.collect()}.
   *
   * @throws NullPointerException if any element is {@code null}
   * @since 14.0 (since 12.0 as {@code toImmutableSet()}).
   */
  public final vendor.google.common.collect.ImmutableSet<E> toSet() {
   ...
   *
   * <p><b>{@code Stream} equivalent:</b> pass {@link vendor.google.common.collect.ImmutableSortedSet#toImmutableSortedSet} to
   * {@code stream.collect()}.
   *
   ...
   */
  public final vendor.google.common.collect.ImmutableSortedSet<E> toSortedSet(Comparator<? super E> comparator) {
   ...
   *
   * <p><b>{@code Stream} equivalent:</b> pass {@link vendor.google.common.collect.ImmutableMultiset#toImmutableMultiset} to
   * {@code stream.collect()}.
   *
   * @throws NullPointerException if any element is null
   * @since 19.0
   */
  public final vendor.google.common.collect.ImmutableMultiset<E> toMultiset() {
  ...
  public final <V> ImmutableMap<E, V> toMap(Function<? super E, V> valueFunction) {
    return vendor.google.common.collect.Maps.toMap(getDelegate(), valueFunction);
  }
  ...
  public final E[] toArray(Class<E> type) {
    return vendor.google.common.collect.Iterables.toArray(getDelegate(), type);
  }
