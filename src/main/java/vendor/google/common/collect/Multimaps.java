...
import static vendor.google.common.collect.CollectPreconditions.checkNonnegative;
import static vendor.google.common.collect.CollectPreconditions.checkRemove;

import vendor.google.common.base.Function;
import vendor.google.common.base.Predicate;
import vendor.google.common.base.Predicates;
import vendor.google.common.base.Supplier;
import vendor.google.common.collect.Maps.EntryTransformer;
...
public final class Multimaps {
   ...
   * @since 21.0
   */
  @vendor.google.common.annotations.Beta
  public static <T, K, V, M extends vendor.google.common.collect.Multimap<K, V>> Collector<T, ?, M> toMultimap(
   ...
   */
  @vendor.google.common.annotations.Beta
  public static <T, K, V, M extends vendor.google.common.collect.Multimap<K, V>> Collector<T, ?, M> flatteningToMultimap(
      java.util.function.Function<? super T, ? extends K> keyFunction,
   ...
   * very surprising behavior from {@link vendor.google.common.collect.Multimap#equals}.
   *
   ...
   *
   * <p>Call this method only when the simpler methods {@link vendor.google.common.collect.ArrayListMultimap#create()}, {@link
   * vendor.google.common.collect.HashMultimap#create()}, {@link vendor.google.common.collect.LinkedHashMultimap#create()}, {@link
   * LinkedListMultimap#create()}, {@link vendor.google.common.collect.TreeMultimap#create()}, and {@link
   * vendor.google.common.collect.TreeMultimap#create(Comparator, Comparator)} won't suffice.
   *
   ...
   */
  public static <K, V> vendor.google.common.collect.Multimap<K, V> newMultimap(
      Map<K, Collection<V>> map, final Supplier<? extends Collection<V>> factory) {
    return new CustomMultimap<>(map, factory);
  }

  private static class CustomMultimap<K, V> extends vendor.google.common.collect.AbstractMapBasedMultimap<K, V> {
    ...
    <E> Collection<E> unmodifiableCollectionSubclass(Collection<E> collection) {
      if (collection instanceof NavigableSet) {
        return vendor.google.common.collect.Sets.unmodifiableNavigableSet((NavigableSet<E>) collection);
    ...
    @vendor.google.common.annotations.GwtIncompatible // java serialization not supported
   ...
   * @throws IllegalArgumentException if {@code map} is not empty
   */
  public static <K, V> vendor.google.common.collect.ListMultimap<K, V> newListMultimap(
      Map<K, Collection<V>> map, final Supplier<? extends List<V>> factory) {
    return new CustomListMultimap<>(map, factory);
  }

  private static class CustomListMultimap<K, V> extends vendor.google.common.collect.AbstractListMultimap<K, V> {
   ...
   * LinkedHashMultimap#create()}, {@link vendor.google.common.collect.TreeMultimap#create()}, and {@link
   * vendor.google.common.collect.TreeMultimap#create(Comparator, Comparator)} won't suffice.
   *
   ...
   * @throws IllegalArgumentException if {@code map} is not empty
   */
  public static <K, V> vendor.google.common.collect.SetMultimap<K, V> newSetMultimap(
   ...
   *
   * <p>Call this method only when the simpler methods {@link vendor.google.common.collect.TreeMultimap#create()} and {@link
  ...
  public static <K, V, M extends vendor.google.common.collect.Multimap<K, V>> M invertFrom(
          vendor.google.common.collect.Multimap<? extends V, ? extends K> source, M dest) {
    checkNotNull(dest);
   ...
   *
   * <p>Note that the generated multimap's {@link vendor.google.common.collect.Multimap#removeAll} and {@link
   * vendor.google.common.collect.Multimap#replaceValues} methods return collections that aren't synchronized.
   *
   ...
   */
  public static <K, V> vendor.google.common.collect.Multimap<K, V> synchronizedMultimap(vendor.google.common.collect.Multimap<K, V> multimap) {
    return vendor.google.common.collect.Synchronized.multimap(multimap, null);
  }
   ...
   */
  public static <K, V> vendor.google.common.collect.Multimap<K, V> unmodifiableMultimap(vendor.google.common.collect.Multimap<K, V> delegate) {
   ...
   */
  @Deprecated
  public static <K, V> vendor.google.common.collect.Multimap<K, V> unmodifiableMultimap(ImmutableMultimap<K, V> delegate) {
    return checkNotNull(delegate);
  }

  private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V>
      implements Serializable {
    final vendor.google.common.collect.Multimap<K, V> delegate;
    ...
    UnmodifiableMultimap(final vendor.google.common.collect.Multimap<K, V> delegate) {
      this.delegate = checkNotNull(delegate);
    }

    @Override
    protected vendor.google.common.collect.Multimap<K, V> delegate() {
      return delegate;
    }
        ...
        result =
            map =
                Collections.unmodifiableMap(
                    vendor.google.common.collect.Maps.transformValues(
                        delegate.asMap(),
    ...
    public Multiset<K> keys() {
      ...
      if (result == null) {
        keys = result = vendor.google.common.collect.Multisets.unmodifiableMultiset(delegate.keys());
      }
      return result;
    }
    ...
    @Override
    public boolean putAll(vendor.google.common.collect.Multimap<? extends K, ? extends V> multimap) {
      throw new UnsupportedOperationException();
    }
  ...
  private static class UnmodifiableListMultimap<K, V> extends UnmodifiableMultimap<K, V>
    ...
    UnmodifiableListMultimap(vendor.google.common.collect.ListMultimap<K, V> delegate) {
      super(delegate);
    }

    @Override
    public vendor.google.common.collect.ListMultimap<K, V> delegate() {
      return (vendor.google.common.collect.ListMultimap<K, V>) super.delegate();
    }
  ...
  private static class UnmodifiableSetMultimap<K, V> extends UnmodifiableMultimap<K, V>
      implements vendor.google.common.collect.SetMultimap<K, V> {
    UnmodifiableSetMultimap(vendor.google.common.collect.SetMultimap<K, V> delegate) {
      super(delegate);
    }

    @Override
    public vendor.google.common.collect.SetMultimap<K, V> delegate() {
      return (vendor.google.common.collect.SetMultimap<K, V>) super.delegate();
    }
    ...
    public Set<Map.Entry<K, V>> entries() {
      return vendor.google.common.collect.Maps.unmodifiableEntrySet(delegate().entries());
    }
   ...
   * @return a synchronized view of the specified multimap
   */
  public static <K, V> vendor.google.common.collect.SetMultimap<K, V> synchronizedSetMultimap(vendor.google.common.collect.SetMultimap<K, V> multimap) {
    return vendor.google.common.collect.Synchronized.setMultimap(multimap, null);
  }
   ...
   * @return an unmodifiable view of the specified multimap
   */
  public static <K, V> vendor.google.common.collect.SetMultimap<K, V> unmodifiableSetMultimap(vendor.google.common.collect.SetMultimap<K, V> delegate) {
    if (delegate instanceof UnmodifiableSetMultimap || delegate instanceof vendor.google.common.collect.ImmutableSetMultimap) {
      return delegate;
    }
   ...
   */
  @Deprecated
  public static <K, V> vendor.google.common.collect.SetMultimap<K, V> unmodifiableSetMultimap(
  ...
  public static <K, V> SortedSetMultimap<K, V> synchronizedSortedSetMultimap(
    ...
    return vendor.google.common.collect.Synchronized.sortedSetMultimap(multimap, null);
  }
   ...
   * @return a synchronized view of the specified multimap
   */
  public static <K, V> vendor.google.common.collect.ListMultimap<K, V> synchronizedListMultimap(vendor.google.common.collect.ListMultimap<K, V> multimap) {
    return vendor.google.common.collect.Synchronized.listMultimap(multimap, null);
  }
   ...
   * @return an unmodifiable view of the specified multimap
   */
  public static <K, V> vendor.google.common.collect.ListMultimap<K, V> unmodifiableListMultimap(vendor.google.common.collect.ListMultimap<K, V> delegate) {
   ...
   */
  @Deprecated
  public static <K, V> vendor.google.common.collect.ListMultimap<K, V> unmodifiableListMultimap(
  ...
  private static <K, V> Collection<Entry<K, V>> unmodifiableEntries(
    ...
    if (entries instanceof Set) {
      return vendor.google.common.collect.Maps.unmodifiableEntrySet((Set<Entry<K, V>>) entries);
    }
    return new vendor.google.common.collect.Maps.UnmodifiableEntries<>(Collections.unmodifiableCollection(entries));
  }

  /**
   * Returns {@link vendor.google.common.collect.ListMultimap#asMap multimap.asMap()}, with its type corrected from {@code Map<K,
  ...
  public static <K, V> Map<K, List<V>> asMap(vendor.google.common.collect.ListMultimap<K, V> multimap) {
    return (Map<K, List<V>>) (Map<K, ?>) multimap.asMap();
  }

  /**
   * Returns {@link vendor.google.common.collect.SetMultimap#asMap multimap.asMap()}, with its type corrected from {@code Map<K,
  ...
  public static <K, V> Map<K, Set<V>> asMap(vendor.google.common.collect.SetMultimap<K, V> multimap) {
  ...
  /**
   * Returns {@link vendor.google.common.collect.Multimap#asMap multimap.asMap()}. This is provided for parity with the other
   * more strongly-typed {@code asMap()} implementations.
   *
   * @since 15.0
   */
  @Beta
  public static <K, V> Map<K, Collection<V>> asMap(vendor.google.common.collect.Multimap<K, V> multimap) {
   ...
   */
  public static <K, V> vendor.google.common.collect.SetMultimap<K, V> forMap(Map<K, V> map) {
    return new MapMultimap<>(map);
  }

  /** @see Multimaps#forMap */
  private static class MapMultimap<K, V> extends vendor.google.common.collect.AbstractMultimap<K, V>
      implements vendor.google.common.collect.SetMultimap<K, V>, Serializable {
    final Map<K, V> map;
    ...
    public boolean containsEntry(Object key, Object value) {
      return map.entrySet().contains(vendor.google.common.collect.Maps.immutableEntry(key, value));
    }
    ...
    @Override
    public boolean remove(Object key, Object value) {
      return map.entrySet().remove(vendor.google.common.collect.Maps.immutableEntry(key, value));
    }
   ...
   * operations like {@link vendor.google.common.collect.Multimap#containsValue} and {@code Multimap.toString()}. For this to
   ...
   * @since 7.0
   */
  public static <K, V1, V2> vendor.google.common.collect.Multimap<K, V2> transformValues(
          vendor.google.common.collect.Multimap<K, V1> fromMultimap, final Function<? super V1, V2> function) {
    checkNotNull(function);
    EntryTransformer<K, V1, V2> transformer = vendor.google.common.collect.Maps.asEntryTransformer(function);
   ...
   * @since 7.0
   */
  public static <K, V1, V2> vendor.google.common.collect.ListMultimap<K, V2> transformValues(
          vendor.google.common.collect.ListMultimap<K, V1> fromMultimap, final Function<? super V1, V2> function) {
    checkNotNull(function);
    EntryTransformer<K, V1, V2> transformer = vendor.google.common.collect.Maps.asEntryTransformer(function);
    return transformEntries(fromMultimap, transformer);
  }
   ...
   * operations like {@link vendor.google.common.collect.Multimap#containsValue} and {@link Object#toString}. For this to perform
   ...
   * @since 7.0
   */
  public static <K, V1, V2> vendor.google.common.collect.Multimap<K, V2> transformEntries(
          vendor.google.common.collect.Multimap<K, V1> fromMap, EntryTransformer<? super K, ? super V1, V2> transformer) {
   ...
   * entries. In contrast to {@link #transformValues(vendor.google.common.collect.ListMultimap, Function)}, this method's
   ...
   * @since 7.0
   */
  public static <K, V1, V2> vendor.google.common.collect.ListMultimap<K, V2> transformEntries(
          vendor.google.common.collect.ListMultimap<K, V1> fromMap, EntryTransformer<? super K, ? super V1, V2> transformer) {
    return new TransformedEntriesListMultimap<>(fromMap, transformer);
  }

  private static class TransformedEntriesMultimap<K, V1, V2> extends vendor.google.common.collect.AbstractMultimap<K, V2> {
    final vendor.google.common.collect.Multimap<K, V1> fromMultimap;
    final EntryTransformer<? super K, ? super V1, V2> transformer;

    TransformedEntriesMultimap(
        vendor.google.common.collect.Multimap<K, V1> fromMultimap,
        final EntryTransformer<? super K, ? super V1, V2> transformer) {
    ...
    Collection<V2> transform(K key, Collection<V1> values) {
      Function<? super V1, V2> function = vendor.google.common.collect.Maps.asValueToValueFunction(transformer, key);
    ...
    Map<K, Collection<V2>> createAsMap() {
      return vendor.google.common.collect.Maps.transformEntries(
          fromMultimap.asMap(),
    ...
    Iterator<Entry<K, V2>> entryIterator() {
      return Iterators.transform(
          fromMultimap.entries().iterator(), vendor.google.common.collect.Maps.<K, V1, V2>asEntryToEntryFunction(transformer));
    }
    ...
    @Override
    public boolean putAll(vendor.google.common.collect.Multimap<? extends K, ? extends V2> multimap) {
      throw new UnsupportedOperationException();
    }
    ...
    Collection<V2> createValues() {
      return Collections2.transform(
          fromMultimap.entries(), vendor.google.common.collect.Maps.<K, V1, V2>asEntryToValueFunction(transformer));
    }
  }

  private static final class TransformedEntriesListMultimap<K, V1, V2>
      extends TransformedEntriesMultimap<K, V1, V2> implements vendor.google.common.collect.ListMultimap<K, V2> {

    TransformedEntriesListMultimap(
            vendor.google.common.collect.ListMultimap<K, V1> fromMultimap, EntryTransformer<? super K, ? super V1, V2> transformer) {
      super(fromMultimap, transformer);
    }

    @Override
    List<V2> transform(K key, Collection<V1> values) {
      return Lists.transform((List<V1>) values, vendor.google.common.collect.Maps.asValueToValueFunction(transformer, key));
    }
  ...
  static class Keys<K, V> extends vendor.google.common.collect.AbstractMultiset<K> {
    @Weak final vendor.google.common.collect.Multimap<K, V> multimap;

    Keys(vendor.google.common.collect.Multimap<K, V> multimap) {
      this.multimap = multimap;
    }

    @Override
    Iterator<Multiset.Entry<K>> entryIterator() {
      return new vendor.google.common.collect.TransformedIterator<Map.Entry<K, Collection<V>>, Entry<K>>(
    ...
    public Iterator<K> iterator() {
      return vendor.google.common.collect.Maps.keyIterator(multimap.entries().iterator());
    }

    @Override
    public int count(@Nullable Object element) {
      Collection<V> values = vendor.google.common.collect.Maps.safeGet(multimap.asMap(), element);
  ...
  /** A skeleton implementation of {@link vendor.google.common.collect.Multimap#entries()}. */
  abstract static class Entries<K, V> extends AbstractCollection<Map.Entry<K, V>> {
    abstract vendor.google.common.collect.Multimap<K, V> multimap();
  ...
  /** A skeleton implementation of {@link vendor.google.common.collect.Multimap#asMap()}. */
  static final class AsMap<K, V> extends vendor.google.common.collect.Maps.ViewCachingAbstractMap<K, Collection<V>> {
    @Weak private final vendor.google.common.collect.Multimap<K, V> multimap;

    AsMap(vendor.google.common.collect.Multimap<K, V> multimap) {
    ...
    @WeakOuter
    class EntrySet extends vendor.google.common.collect.Maps.EntrySet<K, Collection<V>> {
      @Override
      ...
      public Iterator<Entry<K, Collection<V>>> iterator() {
        return vendor.google.common.collect.Maps.asMapEntryIterator(
            multimap.keySet(),
   ...
   * @since 11.0
   */
  public static <K, V> vendor.google.common.collect.Multimap<K, V> filterKeys(
          vendor.google.common.collect.Multimap<K, V> unfiltered, final Predicate<? super K> keyPredicate) {
    if (unfiltered instanceof vendor.google.common.collect.SetMultimap) {
      return filterKeys((vendor.google.common.collect.SetMultimap<K, V>) unfiltered, keyPredicate);
    } else if (unfiltered instanceof vendor.google.common.collect.ListMultimap) {
      return filterKeys((vendor.google.common.collect.ListMultimap<K, V>) unfiltered, keyPredicate);
    } else if (unfiltered instanceof vendor.google.common.collect.FilteredKeyMultimap) {
      vendor.google.common.collect.FilteredKeyMultimap<K, V> prev = (vendor.google.common.collect.FilteredKeyMultimap<K, V>) unfiltered;
      return new vendor.google.common.collect.FilteredKeyMultimap<>(
          prev.unfiltered, Predicates.<K>and(prev.keyPredicate, keyPredicate));
    } else if (unfiltered instanceof vendor.google.common.collect.FilteredMultimap) {
      vendor.google.common.collect.FilteredMultimap<K, V> prev = (vendor.google.common.collect.FilteredMultimap<K, V>) unfiltered;
      return filterFiltered(prev, vendor.google.common.collect.Maps.<K>keyPredicateOnEntries(keyPredicate));
    } else {
      return new vendor.google.common.collect.FilteredKeyMultimap<>(unfiltered, keyPredicate);
    }
  }
   ...
   * @since 14.0
   */
  public static <K, V> vendor.google.common.collect.SetMultimap<K, V> filterKeys(
          vendor.google.common.collect.SetMultimap<K, V> unfiltered, final Predicate<? super K> keyPredicate) {
   ...
   * @since 14.0
   */
  public static <K, V> vendor.google.common.collect.ListMultimap<K, V> filterKeys(
   ...
   * @since 11.0
   */
  public static <K, V> vendor.google.common.collect.Multimap<K, V> filterValues(
          vendor.google.common.collect.Multimap<K, V> unfiltered, final Predicate<? super V> valuePredicate) {
    return filterEntries(unfiltered, vendor.google.common.collect.Maps.<V>valuePredicateOnEntries(valuePredicate));
  }
   ...
   * @since 14.0
   */
  public static <K, V> vendor.google.common.collect.SetMultimap<K, V> filterValues(
          vendor.google.common.collect.SetMultimap<K, V> unfiltered, final Predicate<? super V> valuePredicate) {
   ...
   * @since 11.0
   */
  public static <K, V> vendor.google.common.collect.Multimap<K, V> filterEntries(
          vendor.google.common.collect.Multimap<K, V> unfiltered, Predicate<? super Entry<K, V>> entryPredicate) {
    checkNotNull(entryPredicate);
    if (unfiltered instanceof vendor.google.common.collect.SetMultimap) {
      return filterEntries((vendor.google.common.collect.SetMultimap<K, V>) unfiltered, entryPredicate);
    }
    return (unfiltered instanceof vendor.google.common.collect.FilteredMultimap)
        ? filterFiltered((vendor.google.common.collect.FilteredMultimap<K, V>) unfiltered, entryPredicate)
        : new vendor.google.common.collect.FilteredEntryMultimap<K, V>(checkNotNull(unfiltered), entryPredicate);
  }
   ...
   * @since 14.0
   */
  public static <K, V> vendor.google.common.collect.SetMultimap<K, V> filterEntries(
          vendor.google.common.collect.SetMultimap<K, V> unfiltered, Predicate<? super Entry<K, V>> entryPredicate) {
    checkNotNull(entryPredicate);
   ...
   * avoid that problem.
   */
  private static <K, V> vendor.google.common.collect.Multimap<K, V> filterFiltered(
          vendor.google.common.collect.FilteredMultimap<K, V> multimap, Predicate<? super Entry<K, V>> entryPredicate) {
    Predicate<Entry<K, V>> predicate =
        Predicates.<Entry<K, V>>and(multimap.entryPredicate(), entryPredicate);
    return new vendor.google.common.collect.FilteredEntryMultimap<>(multimap.unfiltered(), predicate);
  }
  ...
  static boolean equalsImpl(vendor.google.common.collect.Multimap<?, ?> multimap, @Nullable Object object) {
    if (object == multimap) {
      return true;
    }
    if (object instanceof vendor.google.common.collect.Multimap) {
      vendor.google.common.collect.Multimap<?, ?> that = (Multimap<?, ?>) object;
