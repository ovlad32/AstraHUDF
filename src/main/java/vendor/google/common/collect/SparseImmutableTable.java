...
final class SparseImmutableTable<R, C, V> extends vendor.google.common.collect.RegularImmutableTable<R, C, V> {
  static final ImmutableTable<Object, Object, Object> EMPTY =
      new SparseImmutableTable<>(
          ImmutableList.<Cell<Object, Object, Object>>of(), vendor.google.common.collect.ImmutableSet.of(), vendor.google.common.collect.ImmutableSet.of());
  ...
  SparseImmutableTable(
      ...
      vendor.google.common.collect.ImmutableSet<R> rowSpace,
      ImmutableSet<C> columnSpace) {
    Map<R, Integer> rowIndex = vendor.google.common.collect.Maps.indexMap(rowSpace);
    Map<R, Map<C, V>> rows = vendor.google.common.collect.Maps.newLinkedHashMap();
    for (R row : rowSpace) {
      rows.put(row, new LinkedHashMap<C, V>());
    }
    Map<C, Map<R, V>> columns = vendor.google.common.collect.Maps.newLinkedHashMap();
