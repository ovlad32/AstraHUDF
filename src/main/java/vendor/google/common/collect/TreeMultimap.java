...
public class TreeMultimap<K, V> extends vendor.google.common.collect.AbstractSortedKeySortedSetMultimap<K, V> {
  ...
  public static <K extends Comparable, V extends Comparable> TreeMultimap<K, V> create() {
    return new TreeMultimap<>(vendor.google.common.collect.Ordering.natural(), vendor.google.common.collect.Ordering.natural());
  }

  /**
   * Creates an empty {@code TreeMultimap} instance using explicit comparators. Neither comparator
   * may be null; use {@link vendor.google.common.collect.Ordering#natural()} to specify natural order.
   *
  ...
  public static <K extends Comparable, V extends Comparable> TreeMultimap<K, V> create(
    ...
    return new TreeMultimap<>(vendor.google.common.collect.Ordering.natural(), Ordering.natural(), multimap);
  }
  ...
  private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
    ...
    vendor.google.common.collect.Serialization.populateMultimap(this, stream);
  }
