...
import static vendor.google.common.base.Preconditions.checkPositionIndex;
...
import vendor.google.common.math.IntMath;
...
public final class Lists {
   ...
   *
   * <p><b>Note:</b> if mutability is not required, use {@link vendor.google.common.collect.ImmutableList#of()} instead.
   *
   ...
   */
  @vendor.google.common.annotations.GwtCompatible(serializable = true)
   ...
   * remove elements later. Otherwise, for non-null elements use {@link vendor.google.common.collect.ImmutableList#of()} (for
   * varargs) or {@link vendor.google.common.collect.ImmutableList#copyOf(Object[])} (for an array) instead. If any elements
   ...
   * shortcut for creating an empty list then calling {@link vendor.google.common.collect.Iterables#addAll}.
   *
   * <p><b>Note:</b> if mutability is not required and the elements are non-null, use {@link
   * vendor.google.common.collect.ImmutableList#copyOf(Iterable)} instead. (Or, change {@code elements} to be a {@link
   * vendor.google.common.collect.FluentIterable} and call {@code elements.toList()}.)
   *
  ...
  /**
   * Creates a <i>mutable</i> {@code ArrayList} instance containing the given elements; a very thin
   * shortcut for creating an empty list and then calling {@link vendor.google.common.collect.Iterators#addAll}.
   *
   * <p><b>Note:</b> if mutability is not required and the elements are non-null, use {@link
   * vendor.google.common.collect.ImmutableList#copyOf(Iterator)} instead.
   */
  @vendor.google.common.annotations.GwtCompatible(serializable = true)
  public static <E> ArrayList<E> newArrayList(Iterator<? extends E> elements) {
    ArrayList<E> list = newArrayList();
    vendor.google.common.collect.Iterators.addAll(list, elements);
    return list;
  }
   ...
   *
   * <p><b>Note:</b> if you won't be adding any elements to the list, use {@link vendor.google.common.collect.ImmutableList#of()}
   * instead.
   *
  ...
  public static <E> LinkedList<E> newLinkedList(Iterable<? extends E> elements) {
    ...
    vendor.google.common.collect.Iterables.addAll(list, elements);
    return list;
  }
   ...
   * @since 12.0
   */
  @vendor.google.common.annotations.GwtIncompatible // CopyOnWriteArrayList
  ...
  public static <B> List<List<B>> cartesianProduct(List<? extends List<? extends B>> lists) {
    return vendor.google.common.collect.CartesianList.create(lists);
  }
   ...
   * Instead, copy the list using {@link vendor.google.common.collect.ImmutableList#copyOf(Collection)} (for example), then
  ...
  private static class TransformingSequentialList<F, T> extends AbstractSequentialList<T>
    ...
    public ListIterator<T> listIterator(final int index) {
      return new vendor.google.common.collect.TransformedListIterator<F, T>(fromList.listIterator(index)) {
        @Override
        T transform(F from) {
   ...
   * @since 7.0
   */
  public static vendor.google.common.collect.ImmutableList<Character> charactersOf(String string) {
  ...
  private static final class StringAsImmutableList extends vendor.google.common.collect.ImmutableList<Character> {
    ...
    @Override
    public vendor.google.common.collect.ImmutableList<Character> subList(int fromIndex, int toIndex) {
  ...
  public static <T> List<T> reverse(List<T> list) {
    if (list instanceof vendor.google.common.collect.ImmutableList) {
