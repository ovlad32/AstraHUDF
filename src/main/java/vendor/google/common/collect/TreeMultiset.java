...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
  ...
  @Override
  public int size() {
    return vendor.google.common.primitives.Ints.saturatedCast(aggregateForEntries(Aggregate.SIZE));
  }
  ...
  private Entry<E> wrapEntry(final AvlNode<E> baseEntry) {
    return new vendor.google.common.collect.Multisets.AbstractEntry<E>() {
      @Override
      public E getElement() {
  ...
  private @Nullable AvlNode<E> firstNode() {
    ...
    if (range.hasLowerBound()) {
      ...
      if (range.getLowerBoundType() == vendor.google.common.collect.BoundType.OPEN
  ...
  private @Nullable AvlNode<E> lastNode() {
    ...
    if (range.hasUpperBound()) {
      ...
      if (range.getUpperBoundType() == vendor.google.common.collect.BoundType.OPEN
          && comparator().compare(endpoint, node.getElement()) == 0) {
        node = node.pred;
      }
    } else {
  ...
  Iterator<E> elementIterator() {
    return vendor.google.common.collect.Multisets.elementIterator(entryIterator());
  }
  ...
  public Iterator<E> iterator() {
    return vendor.google.common.collect.Multisets.iteratorImpl(this);
  }

  @Override
  public vendor.google.common.collect.SortedMultiset<E> headMultiset(@Nullable E upperBound, vendor.google.common.collect.BoundType boundType) {
  ...
  private void writeObject(ObjectOutputStream stream) throws IOException {
    ...
    vendor.google.common.collect.Serialization.writeMultiset(this, stream);
  }
  ...
  private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
    ...
    vendor.google.common.collect.Serialization.getFieldSetter(AbstractSortedMultiset.class, "comparator").set(this, comparator);
    vendor.google.common.collect.Serialization.getFieldSetter(TreeMultiset.class, "range")
        .set(this, GeneralRange.all(comparator));
    vendor.google.common.collect.Serialization.getFieldSetter(TreeMultiset.class, "rootReference")
        .set(this, new Reference<AvlNode<E>>());
    AvlNode<E> header = new AvlNode<E>(null, 1);
    vendor.google.common.collect.Serialization.getFieldSetter(TreeMultiset.class, "header").set(this, header);
    successor(header, header);
    vendor.google.common.collect.Serialization.populateMultiset(this, stream);
  }
