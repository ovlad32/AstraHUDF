...
public final class EnumBiMap<K extends Enum<K>, V extends Enum<V>> extends vendor.google.common.collect.AbstractBiMap<K, V> {
  ...
  static <K extends Enum<K>> Class<K> inferKeyType(Map<K, ?> map) {
    ...
    if (map instanceof vendor.google.common.collect.EnumHashBiMap) {
  ...
  private void writeObject(ObjectOutputStream stream) throws IOException {
    ...
    vendor.google.common.collect.Serialization.writeMap(this, stream);
  }
  ...
  private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
    ...
    vendor.google.common.collect.Serialization.populateMap(this, stream);
  }
