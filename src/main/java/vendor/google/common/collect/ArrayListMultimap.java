...
public final class ArrayListMultimap<K, V>
   ...
   */
  public static <K, V> ArrayListMultimap<K, V> create(vendor.google.common.collect.Multimap<? extends K, ? extends V> multimap) {
  ...
  private ArrayListMultimap(int expectedKeys, int expectedValuesPerKey) {
    super(vendor.google.common.collect.Platform.<K, Collection<V>>newHashMapWithExpectedSize(expectedKeys));
  ...
  private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
    ...
    int distinctKeys = vendor.google.common.collect.Serialization.readCount(stream);
    Map<K, Collection<V>> map = Maps.newHashMap();
    setMap(map);
    vendor.google.common.collect.Serialization.populateMultimap(this, stream, distinctKeys);
  }
