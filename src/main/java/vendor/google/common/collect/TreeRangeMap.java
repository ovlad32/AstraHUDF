...
import static vendor.google.common.base.Predicates.compose;
...
public final class TreeRangeMap<K extends Comparable, V> implements RangeMap<K, V> {
  ...
  private TreeRangeMap() {
    this.entriesByLowerBound = vendor.google.common.collect.Maps.newTreeMap();
  }

  private static final class RangeMapEntry<K extends Comparable, V>
      extends vendor.google.common.collect.AbstractMapEntry<Range<K>, V> {
  ...
  private class SubRangeMap implements RangeMap<K, V> {
    ...
    public @Nullable Entry<Range<K>, V> getEntry(K key) {
      if (subRange.contains(key)) {
        ...
        if (entry != null) {
          return vendor.google.common.collect.Maps.immutableEntry(entry.getKey().intersection(subRange), entry.getValue());
        }
      }
      return null;
    }
        ...
        Iterator<Entry<Range<K>, V>> entryIterator() {
          ...
          final Iterator<RangeMapEntry<K, V>> backingItr =
              entriesByLowerBound
                  ...
                  .values()
                  .iterator();
          return new vendor.google.common.collect.AbstractIterator<Entry<Range<K>, V>>() {
    ...
    class SubRangeMapAsMap extends AbstractMap<Range<K>, V> {
      ...
      public Set<Range<K>> keySet() {
        return new vendor.google.common.collect.Maps.KeySet<Range<K>, V>(SubRangeMapAsMap.this) {
          @Override
          ...
          public boolean retainAll(Collection<?> c) {
            return removeEntryIf(compose(not(in(c)), vendor.google.common.collect.Maps.<Range<K>>keyFunction()));
          }
        };
      }
      ...
      public Set<Entry<Range<K>, V>> entrySet() {
        return new vendor.google.common.collect.Maps.EntrySet<Range<K>, V>() {
          @Override
          Map<Range<K>, V> map() {
      ...
      public Collection<V> values() {
        return new vendor.google.common.collect.Maps.Values<Range<K>, V>(this) {
          @Override
          public boolean removeAll(Collection<?> c) {
            return removeEntryIf(compose(in(c), vendor.google.common.collect.Maps.<V>valueFunction()));
          }
