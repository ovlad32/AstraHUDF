 ...
 */
@GwtCompatible
public abstract class ForwardingMultiset<E> extends ForwardingCollection<E> implements vendor.google.common.collect.Multiset<E> {

  /** Constructor for use by subclasses. */
  protected ForwardingMultiset() {}

  @Override
  protected abstract vendor.google.common.collect.Multiset<E> delegate();
  ...
  protected boolean standardAddAll(Collection<? extends E> elementsToAdd) {
    return vendor.google.common.collect.Multisets.addAllImpl(this, elementsToAdd);
  }
  ...
  protected boolean standardRemoveAll(Collection<?> elementsToRemove) {
    return vendor.google.common.collect.Multisets.removeAllImpl(this, elementsToRemove);
  }
  ...
  protected boolean standardRetainAll(Collection<?> elementsToRetain) {
    return vendor.google.common.collect.Multisets.retainAllImpl(this, elementsToRetain);
  }
  ...
  protected int standardSetCount(E element, int count) {
    return vendor.google.common.collect.Multisets.setCountImpl(this, element, count);
  }
  ...
  protected boolean standardSetCount(E element, int oldCount, int newCount) {
    return vendor.google.common.collect.Multisets.setCountImpl(this, element, oldCount, newCount);
  }

  /**
   * A sensible implementation of {@link vendor.google.common.collect.Multiset#elementSet} in terms of the following methods:
   ...
   */
  @Beta
  protected class StandardElementSet extends vendor.google.common.collect.Multisets.ElementSet<E> {
    /** Constructor for use by subclasses. */
    ...
    public Iterator<E> iterator() {
      return vendor.google.common.collect.Multisets.elementIterator(multiset().entrySet().iterator());
    }
  }
  ...
  protected int standardSize() {
    return vendor.google.common.collect.Multisets.linearTimeSizeImpl(this);
  }
