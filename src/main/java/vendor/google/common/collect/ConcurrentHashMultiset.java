...
import vendor.google.common.collect.Serialization.FieldSetter;
...
public final class ConcurrentHashMultiset<E> extends AbstractMultiset<E> implements Serializable {
  ...
  private static class FieldSettersHolder {
    static final FieldSetter<ConcurrentHashMultiset> COUNT_MAP_FIELD_SETTER =
        vendor.google.common.collect.Serialization.getFieldSetter(ConcurrentHashMultiset.class, "countMap");
  }
  ...
  public int count(@Nullable Object element) {
    AtomicInteger existingCounter = vendor.google.common.collect.Maps.safeGet(countMap, element);
  ...
  Iterator<Multiset.Entry<E>> entryIterator() {
    ...
    final Iterator<Multiset.Entry<E>> readOnlyIterator =
        new AbstractIterator<Entry<E>>() {
          ...
          protected Multiset.Entry<E> computeNext() {
            while (true) {
              ...
              if (count != 0) {
                return vendor.google.common.collect.Multisets.immutableEntry(mapEntry.getKey(), count);
              }
            }
          }
        };
