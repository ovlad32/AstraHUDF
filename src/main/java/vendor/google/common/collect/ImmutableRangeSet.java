...
public final class ImmutableRangeSet<C extends Comparable> extends vendor.google.common.collect.AbstractRangeSet<C>
  ...
  private final class AsSet extends ImmutableSortedSet<C> {
    ...
    public int size() {
      ...
      if (result == null) {
        ...
        result = size = vendor.google.common.primitives.Ints.saturatedCast(total);
      }
    ...
    public UnmodifiableIterator<C> iterator() {
      return new vendor.google.common.collect.AbstractIterator<C>() {
    ...
    ImmutableSortedSet<C> headSetImpl(C toElement, boolean inclusive) {
      return subSet(Range.upTo(toElement, vendor.google.common.collect.BoundType.forBoolean(inclusive)));
    }
