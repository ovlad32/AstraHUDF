...
final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E> {
  ...
  public boolean containsAll(Collection<?> targets) {
    ...
    if (!vendor.google.common.collect.SortedIterables.hasSameComparator(comparator(), targets) || (targets.size() <= 1)) {
  ...
  public boolean equals(@Nullable Object object) {
    ...
    if (vendor.google.common.collect.SortedIterables.hasSameComparator(comparator, that)) {
