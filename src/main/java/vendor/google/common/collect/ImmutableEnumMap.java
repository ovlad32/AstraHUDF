...
import vendor.google.common.collect.ImmutableMap.IteratorBasedImmutableMap;
...
/**
 * Implementation of {@link vendor.google.common.collect.ImmutableMap} backed by a non-empty {@link java.util.EnumMap}.
 *
...
final class ImmutableEnumMap<K extends Enum<K>, V> extends IteratorBasedImmutableMap<K, V> {
  static <K extends Enum<K>, V> vendor.google.common.collect.ImmutableMap<K, V> asImmutable(EnumMap<K, V> map) {
    switch (map.size()) {
      case 0:
  ...
  @Override
  vendor.google.common.collect.UnmodifiableIterator<K> keyIterator() {
  ...
  UnmodifiableIterator<Entry<K, V>> entryIterator() {
    return vendor.google.common.collect.Maps.unmodifiableEntryIterator(delegate.entrySet().iterator());
  }
