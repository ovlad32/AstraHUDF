 ...
 */
@GwtCompatible
public abstract class ForwardingTable<R, C, V> extends ForwardingObject implements vendor.google.common.collect.Table<R, C, V> {
  /** Constructor for use by subclasses. */
  protected ForwardingTable() {}

  @Override
  protected abstract vendor.google.common.collect.Table<R, C, V> delegate();
