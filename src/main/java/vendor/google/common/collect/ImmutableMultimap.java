...
/**
 * A {@link vendor.google.common.collect.Multimap} whose contents will never change, with many other important properties
 * detailed at {@link ImmutableCollection}.
 *
 * <p><b>Warning:</b> avoid <i>direct</i> usage of {@link ImmutableMultimap} as a type (as with
 * {@link vendor.google.common.collect.Multimap} itself). Prefer subtypes such as {@link ImmutableSetMultimap} or {@link
 ...
 * #copyOf(vendor.google.common.collect.Multimap)}) instead preserves key-grouped order by inserting entries for an existing key
...
public abstract class ImmutableMultimap<K, V> extends BaseImmutableMultimap<K, V>
  ...
  public static class Builder<K, V> {
     ...
     */
    public Builder() {
      this.builderMap = vendor.google.common.collect.Platform.preservesInsertionOrderOnPutsMap();
    }
   ...
   */
  public static <K, V> ImmutableMultimap<K, V> copyOf(vendor.google.common.collect.Multimap<? extends K, ? extends V> multimap) {
  ...
  // deserialized.
  @vendor.google.common.annotations.GwtIncompatible // java serialization is not supported
  static class FieldSettersHolder {
    static final vendor.google.common.collect.Serialization.FieldSetter<ImmutableMultimap> MAP_FIELD_SETTER =
        vendor.google.common.collect.Serialization.getFieldSetter(ImmutableMultimap.class, "map");
    static final vendor.google.common.collect.Serialization.FieldSetter<ImmutableMultimap> SIZE_FIELD_SETTER =
        vendor.google.common.collect.Serialization.getFieldSetter(ImmutableMultimap.class, "size");
  }
  ...
  UnmodifiableIterator<Entry<K, V>> entryIterator() {
    return new UnmodifiableIterator<Entry<K, V>>() {
      ...
      K currentKey = null;
      Iterator<V> valueItr = vendor.google.common.collect.Iterators.emptyIterator();
      ...
      public Entry<K, V> next() {
        ...
        return vendor.google.common.collect.Maps.immutableEntry(currentKey, valueItr.next());
      }
    };
  }
   ...
   */
  @Override
  public vendor.google.common.collect.ImmutableMultiset<K> keys() {
    return (vendor.google.common.collect.ImmutableMultiset<K>) super.keys();
  }

  @Override
  vendor.google.common.collect.ImmutableMultiset<K> createKeys() {
    return new Keys();
  }
