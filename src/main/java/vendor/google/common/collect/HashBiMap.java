...
/**
 * A {@link vendor.google.common.collect.BiMap} backed by two hash tables. This implementation allows null keys and values. A
...
public final class HashBiMap<K, V> extends Maps.IteratorBasedAbstractMap<K, V>
  ...
  Iterator<Entry<K, V>> entryIterator() {
    return new Itr<Entry<K, V>>() {
      ...
      class MapEntry extends vendor.google.common.collect.AbstractMapEntry<K, V> {
  ...
  @Override
  public vendor.google.common.collect.BiMap<V, K> inverse() {
    vendor.google.common.collect.BiMap<V, K> result = inverse;
    return (result == null) ? inverse = new Inverse() : result;
  }

  private final class Inverse extends Maps.IteratorBasedAbstractMap<V, K>
      implements vendor.google.common.collect.BiMap<V, K>, Serializable {
    vendor.google.common.collect.BiMap<K, V> forward() {
    ...
    Iterator<Entry<V, K>> entryIterator() {
      return new Itr<Entry<V, K>>() {
        ...
        class InverseEntry extends vendor.google.common.collect.AbstractMapEntry<V, K> {
          BiEntry<K, V> delegate;
