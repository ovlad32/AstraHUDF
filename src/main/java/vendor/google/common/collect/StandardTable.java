...
import static vendor.google.common.base.Predicates.alwaysTrue;
...
import static vendor.google.common.collect.Maps.safeContainsKey;
import static vendor.google.common.collect.Maps.safeGet;
...
import vendor.google.common.collect.Maps.IteratorBasedAbstractMap;
import vendor.google.common.collect.Maps.ViewCachingAbstractMap;
import vendor.google.common.collect.Sets.ImprovedAbstractSet;
...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
  @vendor.google.common.collect.GwtTransient
  ...
  private class CellIterator implements Iterator<Cell<R, C, V>> {
    ...
    public Cell<R, C, V> next() {
      ...
      return vendor.google.common.collect.Tables.immutableCell(rowEntry.getKey(), columnEntry.getKey(), columnEntry.getValue());
    }
  ...
  class Row extends IteratorBasedAbstractMap<C, V> {
    ...
    public boolean containsKey(Object key) {
      ...
      return (key != null && backingRowMap != null) && vendor.google.common.collect.Maps.safeContainsKey(backingRowMap, key);
    }

    @Override
    public V get(Object key) {
      Map<C, V> backingRowMap = backingRowMap();
      return (key != null && backingRowMap != null) ? vendor.google.common.collect.Maps.safeGet(backingRowMap, key) : null;
    }
    ...
    public V remove(Object key) {
      ...
      V result = vendor.google.common.collect.Maps.safeRemove(backingRowMap, key);
  ...
  private class Column extends ViewCachingAbstractMap<R, V> {
    ...
    boolean removeFromColumnIf(Predicate<? super Entry<R, V>> predicate) {
      ...
      while (iterator.hasNext()) {
        ...
        if (value != null && predicate.apply(vendor.google.common.collect.Maps.immutableEntry(entry.getKey(), value))) {
    ...
    private class EntrySetIterator extends vendor.google.common.collect.AbstractIterator<Entry<R, V>> {
      ...
      protected Entry<R, V> computeNext() {
        while (iterator.hasNext()) {
          ...
          if (entry.getValue().containsKey(columnKey)) {
            @WeakOuter
            class EntryImpl extends vendor.google.common.collect.AbstractMapEntry<R, V> {
              @Override
              public R getKey() {
                return entry.getKey();
              }
    ...
    @WeakOuter
    private class KeySet extends vendor.google.common.collect.Maps.KeySet<R, V> {
      KeySet() {
        super(Column.this);
      }
      ...
      public boolean retainAll(final Collection<?> c) {
        return removeFromColumnIf(vendor.google.common.collect.Maps.<R>keyPredicateOnEntries(not(in(c))));
      }
    }
    ...
    @WeakOuter
    private class Values extends vendor.google.common.collect.Maps.Values<R, V> {
      Values() {
        super(Column.this);
      }
      ...
      @Override
      public boolean remove(Object obj) {
        return obj != null && removeFromColumnIf(vendor.google.common.collect.Maps.<V>valuePredicateOnEntries(equalTo(obj)));
      }

      @Override
      public boolean removeAll(final Collection<?> c) {
        return removeFromColumnIf(vendor.google.common.collect.Maps.<V>valuePredicateOnEntries(in(c)));
      }

      @Override
      public boolean retainAll(final Collection<?> c) {
        return removeFromColumnIf(vendor.google.common.collect.Maps.<V>valuePredicateOnEntries(not(in(c))));
      }
    }
  }
    ...
    class ColumnMapEntrySet extends TableSet<Entry<C, Map<R, V>>> {
      ...
      public boolean retainAll(Collection<?> c) {
        ...
        for (C columnKey : Lists.newArrayList(columnKeySet().iterator())) {
          if (!c.contains(vendor.google.common.collect.Maps.immutableEntry(columnKey, column(columnKey)))) {
