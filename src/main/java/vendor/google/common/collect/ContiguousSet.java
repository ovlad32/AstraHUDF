...
/**
 * A sorted set of contiguous values in a given {@link vendor.google.common.collect.DiscreteDomain}. Example:
 *
 * <pre>{@code
...
public abstract class ContiguousSet<C extends Comparable> extends ImmutableSortedSet<C> {
  ...
  public static <C extends Comparable> ContiguousSet<C> create(
      Range<C> range, vendor.google.common.collect.DiscreteDomain<C> domain) {
    checkNotNull(range);
    checkNotNull(domain);
    ...
    return empty
        ? new vendor.google.common.collect.EmptyContiguousSet<C>(domain)
        : new vendor.google.common.collect.RegularContiguousSet<C>(effectiveRange, domain);
  }
  ...
  public static ContiguousSet<Integer> closed(int lower, int upper) {
    return create(Range.closed(lower, upper), vendor.google.common.collect.DiscreteDomain.integers());
  }
  ...
  public static ContiguousSet<Long> closed(long lower, long upper) {
    return create(Range.closed(lower, upper), vendor.google.common.collect.DiscreteDomain.longs());
  }
  ...
  public static ContiguousSet<Integer> closedOpen(int lower, int upper) {
    return create(Range.closedOpen(lower, upper), vendor.google.common.collect.DiscreteDomain.integers());
  }
  ...
  public static ContiguousSet<Long> closedOpen(long lower, long upper) {
    return create(Range.closedOpen(lower, upper), vendor.google.common.collect.DiscreteDomain.longs());
  }

  final vendor.google.common.collect.DiscreteDomain<C> domain;
   ...
   *
   * <p>Note that this method will return ranges with unbounded endpoints if {@link vendor.google.common.collect.BoundType#OPEN}
   ...
   * @throws NoSuchElementException if this set is empty
   */
  public abstract Range<C> range(vendor.google.common.collect.BoundType lowerBoundType, BoundType upperBoundType);
