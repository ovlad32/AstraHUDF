 ...
 * vendor.google.common.collect.AbstractMapBasedMultimap} that converts the returned collections into sorted sets. The {@link
 * #createCollection} method must return a {@code SortedSet}.
 *
 * @author Jared Levy
 */
@GwtCompatible
abstract class AbstractSortedSetMultimap<K, V> extends vendor.google.common.collect.AbstractSetMultimap<K, V>
   ...
   * vendor.google.common.collect.Multimap} interface.
   */
  @Override
