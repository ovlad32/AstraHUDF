...
class CompactHashMap<K, V> extends AbstractMap<K, V> implements Serializable {
  ...
  @WeakOuter
  class KeySetView extends vendor.google.common.collect.Maps.KeySet<K, V> {
    KeySetView() {
  ...
  @WeakOuter
  class EntrySetView extends vendor.google.common.collect.Maps.EntrySet<K, V> {
    @Override
    Map<K, V> map() {
  ...
  final class MapEntry extends vendor.google.common.collect.AbstractMapEntry<K, V> {
