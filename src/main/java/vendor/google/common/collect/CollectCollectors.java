...
final class CollectCollectors {
  ...
  private static final Collector<Object, ?, vendor.google.common.collect.ImmutableSet<Object>> TO_IMMUTABLE_SET =
      Collector.of(
          vendor.google.common.collect.ImmutableSet::<Object>builder,
          vendor.google.common.collect.ImmutableSet.Builder::add,
          vendor.google.common.collect.ImmutableSet.Builder::combine,
          vendor.google.common.collect.ImmutableSet.Builder::build);

  static <E> Collector<E, ?, ImmutableSet<E>> toImmutableSet() {
    return (Collector) TO_IMMUTABLE_SET;
  }

  static <T, K, V> Collector<T, ?, vendor.google.common.collect.ImmutableSortedMap<K, V>> toImmutableSortedMap(
     ...
     */
    return Collector.of(
        () -> new vendor.google.common.collect.ImmutableSortedMap.Builder<K, V>(comparator),
        (builder, input) -> builder.put(keyFunction.apply(input), valueFunction.apply(input)),
        vendor.google.common.collect.ImmutableSortedMap.Builder::combine,
  ...
  private static final Collector<Range<Comparable>, ?, vendor.google.common.collect.ImmutableRangeSet<Comparable>>
      TO_IMMUTABLE_RANGE_SET =
          Collector.of(
              vendor.google.common.collect.ImmutableRangeSet::<Comparable>builder,
              vendor.google.common.collect.ImmutableRangeSet.Builder::add,
              vendor.google.common.collect.ImmutableRangeSet.Builder::combine,
              vendor.google.common.collect.ImmutableRangeSet.Builder::build);
