...
public abstract class MultimapBuilder<K0, V0> {
  ...
  public static MultimapBuilderWithKeys<Object> hashKeys(final int expectedKeys) {
    ...
    return new MultimapBuilderWithKeys<Object>() {
      ...
      <K, V> Map<K, Collection<V>> createMap() {
        return vendor.google.common.collect.Platform.newHashMapWithExpectedSize(expectedKeys);
      }
    };
  }
   ...
   * Uses a hash table to map keys to value collections.
   *
   * <p>The collections returned by {@link vendor.google.common.collect.Multimap#keySet()}, {@link vendor.google.common.collect.Multimap#keys()}, and {@link
   * vendor.google.common.collect.Multimap#asMap()} will iterate through the keys in the order that they were first added to the
  ...
  public static MultimapBuilderWithKeys<Object> linkedHashKeys(final int expectedKeys) {
    ...
    return new MultimapBuilderWithKeys<Object>() {
      @Override
      <K, V> Map<K, Collection<V>> createMap() {
        return vendor.google.common.collect.Platform.newLinkedHashMapWithExpectedSize(expectedKeys);
      }
    };
  }
   ...
   *
   * <p>The collections returned by {@link vendor.google.common.collect.Multimap#keySet()}, {@link vendor.google.common.collect.Multimap#keys()}, and {@link
   * vendor.google.common.collect.Multimap#asMap()} will iterate through the keys in sorted order.
   *
   * <p>For all multimaps generated by the resulting builder, the {@link vendor.google.common.collect.Multimap#keySet()} can be
   * safely cast to a {@link java.util.SortedSet}, and the {@link vendor.google.common.collect.Multimap#asMap()} can safely be
   * cast to a {@link java.util.SortedMap}.
   */
  @SuppressWarnings("rawtypes")
  public static MultimapBuilderWithKeys<Comparable> treeKeys() {
    return treeKeys(vendor.google.common.collect.Ordering.natural());
  }
  ...
  private static final class HashSetSupplier<V> implements Supplier<Set<V>>, Serializable {
    ...
    @Override
    public Set<V> get() {
      return vendor.google.common.collect.Platform.newHashSetWithExpectedSize(expectedValuesPerKey);
    }
  }
  ...
  private static final class LinkedHashSetSupplier<V> implements Supplier<Set<V>>, Serializable {
    ...
    @Override
    public Set<V> get() {
      return vendor.google.common.collect.Platform.newLinkedHashSetWithExpectedSize(expectedValuesPerKey);
    }
  }
  ...
  public abstract static class MultimapBuilderWithKeys<K0> {
    ...
    public ListMultimapBuilder<K0, Object> arrayListValues(final int expectedValuesPerKey) {
      ...
      return new ListMultimapBuilder<K0, Object>() {
        @Override
        public <K extends K0, V> vendor.google.common.collect.ListMultimap<K, V> build() {
          return vendor.google.common.collect.Multimaps.newListMultimap(
    ...
    public SetMultimapBuilder<K0, Object> hashSetValues(final int expectedValuesPerKey) {
      ...
      return new SetMultimapBuilder<K0, Object>() {
        @Override
        public <K extends K0, V> vendor.google.common.collect.SetMultimap<K, V> build() {
          return vendor.google.common.collect.Multimaps.newSetMultimap(
              MultimapBuilderWithKeys.this.<K, V>createMap(),
    ...
    public <V0> SortedSetMultimapBuilder<K0, V0> treeSetValues(final Comparator<V0> comparator) {
      ...
      return new SortedSetMultimapBuilder<K0, V0>() {
        ...
        public <K extends K0, V extends V0> SortedSetMultimap<K, V> build() {
          return vendor.google.common.collect.Multimaps.newSortedSetMultimap(
    ...
    public <V0 extends Enum<V0>> SetMultimapBuilder<K0, V0> enumSetValues(
      ...
      return new SetMultimapBuilder<K0, V0>() {
        @Override
        public <K extends K0, V extends V0> vendor.google.common.collect.SetMultimap<K, V> build() {
  ...
  public abstract <K extends K0, V extends V0> vendor.google.common.collect.Multimap<K, V> build();

  /**
   * Returns a {@code Multimap} with the specified implementation, initialized with the entries of
   * {@code multimap}.
   */
  public <K extends K0, V extends V0> vendor.google.common.collect.Multimap<K, V> build(
      vendor.google.common.collect.Multimap<? extends K, ? extends V> multimap) {
    vendor.google.common.collect.Multimap<K, V> result = build();
    result.putAll(multimap);
    return result;
  }

  /**
   * A specialization of {@link MultimapBuilder} that generates {@link vendor.google.common.collect.ListMultimap} instances.
   *
   * @since 16.0
   */
  public abstract static class ListMultimapBuilder<K0, V0> extends MultimapBuilder<K0, V0> {
    ...
    @Override
    public abstract <K extends K0, V extends V0> vendor.google.common.collect.ListMultimap<K, V> build();

    @Override
    public <K extends K0, V extends V0> vendor.google.common.collect.ListMultimap<K, V> build(
        vendor.google.common.collect.Multimap<? extends K, ? extends V> multimap) {
  ...
  /**
   * A specialization of {@link MultimapBuilder} that generates {@link vendor.google.common.collect.SetMultimap} instances.
   *
   * @since 16.0
   */
  public abstract static class SetMultimapBuilder<K0, V0> extends MultimapBuilder<K0, V0> {
    ...
    @Override
    public abstract <K extends K0, V extends V0> vendor.google.common.collect.SetMultimap<K, V> build();
